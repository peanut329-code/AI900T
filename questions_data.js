const QUESTIONS_DATA = [
  {
    ...
    options: ["A. 機器學習", "B. 知識採礦", "C. 深度學習", "D. 電腦視覺"],
    subQuestions: null,
    answer: "B. 知識採礦",
  ...
  },
  {
    ...
    options: ["A. 機器學習", "B. 深度學習", "C. 數據採礦 (Data Mining/Knowledge Mining)", "D. 電腦視覺"],
    subQuestions: null,
    answer: "C. 數據採礦 (Data Mining/Knowledge Mining)",
  ...
  },
  {
    ...
    options: ["A. 包容 (Inclusiveness)", "B. 機器學習", "C. 深度學習", "D. 電腦視覺"],
    subQuestions: null,
    answer: "A. 包容 (Inclusiveness)",
  ...
  },
  {
    ...
    options: ["A. 問責 (Accountability)、隱私權和安全性 (Privacy and Security)", "B. 公平性", "C. 透明度", "D. 包容性"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 公平性", "B. 可靠性與安全性", "C. 隱私權與安全性", "D. 透明度 (Transparency)"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 公平性 (Fairness)", "B. 可靠性與安全性", "C. 隱私權與安全性", "D. 包容性"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 機器學習", "B. 深度學習", "C. 種族、性別", "D. 電腦視覺"],
    subQuestions: null,
    answer: "C. 種族、性別",
    rationale: "公平性 (Fairness) 著重於識別和減輕 AI 模型中的偏差，確保系統對所有群體做出公正決策。這特別重要於貸款審批、招聘、醫療診斷等高風險決策場景。需要評估訓練資料是否存在歷史偏見。",
    examTip: "看到「偏差」、「偏見」、「貸款」、「種族/性別考量」時，答案是公平性。",
  ...
  },
  {
    ...
    options: ["A. 機器學習", "B. 深度學習", "C. 可靠性和安全性 (Reliability and Safety)", "D. 電腦視覺"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 機器學習", "B. 深度學習", "C. 問責 (Accountability)", "D. 電腦視覺"],
    subQuestions: null,
    answer: "C. 問責 (Accountability)",
    rationale: "問責性 (Accountability) 確保人們對 AI 系統的設計和運作負責。這包括：建立治理架構、定義角色職責、確保遵守法律和道德標準、建立申訴和補救機制。組織必須能夠解釋 AI 決策並承擔後果。",
    examTip: "看到「法律」、「道德標準」、「治理」、「組織原則架構」等關鍵字，答案是問責性。",
    source: 1
  },
  {
    ...
    options: ["A. 迴歸 (Regression)", "B. 分類", "C. 叢集", "D. 強化學習"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 迴歸", "B. 分類 (Classification)", "C. 叢集", "D. 強化學習"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 機器學習", "B. 深度學習", "C. 電腦視覺", "D. 聚類 (Clustering)"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 機器學習", "B. 聚類", "C. 深度學習", "D. 電腦視覺"],
    subQuestions: null,
    answer: "B. 聚類",
    rationale: "聚類/叢集 (Clustering) 是非監督式學習演算法，無需預先定義的標籤，根據資料的相似性自動分組。常見應用：客戶分群、市場區隔、異常偵測。K-Means 是最常見的聚類演算法。",
    examTip: "看到「分組」、「相似屬性」、「無標籤」、「市場區隔」時，答案是聚類。聚類 = 找相似的放一起。",
  ...
  },
  {
    ...
    options: ["A. 叢集", "B. 強化學習", "C. 羅吉斯迴歸 (Logistic Regression) 或 多重線性迴歸 (視題目強調機率分類還是數值而定，AI900中通常羅吉斯迴歸用於二元分類)", "D. 監督式學習"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 特徵", "B. 參數", "C. 兩個功能 (Features) 和一個標籤 (Label)", "D. 輸出層"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 機器學習", "B. 深度學習", "C. 功能 (Features) 彼此獨立", "D. 電腦視覺"],
    subQuestions: null,
    answer: "C. 功能 (Features) 彼此獨立",
    rationale: "此題考察機器學習基本概念。",
    examTip: "迴歸=預測數值、分類=預測類別、聚類=自動分組（無標籤）。特徵=輸入、標籤=輸出。",
    source: 1
  },
  {
    ...
    options: ["A. 標籤", "B. 參數", "C. 超參數", "D. 已知特徵和標籤"],
    subQuestions: null,
    answer: "D. 已知特徵和標籤",
    rationale: "迴歸 (Regression) 是監督式學習演算法，用於預測連續數值。常見應用：房價預測、溫度預測、銷售額預測、能源消耗預測。模型學習特徵與標籤之間的數學關係來進行預測。",
    examTip: "看到預測「數值」、「數量」、「金額」、「價格」等連續值時，答案是迴歸。記住：迴歸 = 預測數字。",
  ...
  },
  {
    ...
    options: ["A. 標籤", "B. 已知特徵和標籤 (用於與預測結果比對)", "C. 參數", "D. 超參數"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 房子的價格", "B. 機器學習", "C. 深度學習", "D. 電腦視覺"],
    subQuestions: null,
    answer: "A. 房子的價格",
    rationale: "此題考察機器學習基本概念。",
    examTip: "迴歸=預測數值、分類=預測類別、聚類=自動分組（無標籤）。特徵=輸入、標籤=輸出。",
  ...
  },
  {
    ...
    options: ["A. 機器學習", "B. 深度學習", "C. 用水", "D. 電腦視覺"],
    subQuestions: null,
    answer: "C. 用水",
    rationale: "此題考察機器學習基本概念。",
    examTip: "迴歸=預測數值、分類=預測類別、聚類=自動分組（無標籤）。特徵=輸入、標籤=輸出。",
  ...
  },
  {
    ...
    options: ["A. 學習率", "B. 天氣溫度、工作日或週末 (這些是輸入變數)", "C. 批次大小", "D. 迭代次數"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 機器學習", "B. 深度學習", "C. 電腦視覺", "D. 將數據分割成定型和驗證數據集"],
    subQuestions: null,
    answer: "D. 將數據分割成定型和驗證數據集",
    rationale: "此題考察機器學習基本概念。",
    examTip: "迴歸=預測數值、分類=預測類別、聚類=自動分組（無標籤）。特徵=輸入、標籤=輸出。",
    source: 1
  },
  {
    ...
    options: ["A. 評估已定型的模型", "B. 機器學習", "C. 深度學習", "D. 電腦視覺"],
    subQuestions: null,
    answer: "A. 評估已定型的模型",
    rationale: "此題考察機器學習基本概念。",
    examTip: "迴歸=預測數值、分類=預測類別、聚類=自動分組（無標籤）。特徵=輸入、標籤=輸出。",
  ...
  },
  {
    ...
    options: ["A. 機器學習", "B. 數據集 (Dataset) (注意：需先有工作區，但在Studio內的操作通常始於數據集或作業)", "C. 深度學習", "D. 電腦視覺"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 機器學習", "B. 深度學習", "C. 作業 (Job)", "D. 電腦視覺"],
    subQuestions: null,
    answer: "C. 作業 (Job)",
    rationale: "迴歸 (Regression) 是監督式學習演算法，用於預測連續數值。常見應用：房價預測、溫度預測、銷售額預測、能源消耗預測。模型學習特徵與標籤之間的數學關係來進行預測。",
    examTip: "看到預測「數值」、「數量」、「金額」、「價格」等連續值時，答案是迴歸。記住：迴歸 = 預測數字。",
  ...
  },
  {
    ...
    options: ["A. 機器學習", "B. 建立管線 (Pipeline)", "C. 深度學習", "D. 電腦視覺"],
    subQuestions: null,
    answer: "B. 建立管線 (Pipeline)",
  ...
  },
  {
    ...
    options: ["A. 機器學習", "B. 深度學習", "C. 電腦視覺", "D. 建立推斷管線 (Inference Pipeline)"],
    subQuestions: null,
    answer: "D. 建立推斷管線 (Inference Pipeline)",
    rationale: "Azure Machine Learning 設計工具 (Designer) 提供拖放式視覺化介面來建立機器學習管線。使用流程：1) 建立管線 (Pipeline) 2) 訓練模型 3) 建立推斷管線 (Inference Pipeline) 4) 部署為端點。",
    examTip: "設計工具 = 拖放式 UI；管線 = 訓練流程；推斷管線 = 部署用的流程。",
    source: 1
  },
  {
    ...
    options: ["A. 叢集", "B. 強化學習", "C. 分類、迴歸、時間序列預測", "D. 監督式學習"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 分類", "B. 叢集", "C. 線性迴歸 (Linear Regression)", "D. 強化學習"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. K-Means 叢集", "B. 迴歸", "C. 分類", "D. 強化學習"],
    subQuestions: null,
    answer: "A. K-Means 叢集",
    rationale: "Azure Machine Learning 設計工具 (Designer) 提供拖放式視覺化介面來建立機器學習管線。使用流程：1) 建立管線 (Pipeline) 2) 訓練模型 3) 建立推斷管線 (Inference Pipeline) 4) 部署為端點。",
    examTip: "設計工具 = 拖放式 UI；管線 = 訓練流程；推斷管線 = 部署用的流程。",
  ...
  },
  {
    ...
    options: ["A. 機器學習", "B. 深度學習", "C. 電腦視覺", "D. 清除遺漏的資料、將資料標準化、選取資料集中的資料行"],
    subQuestions: null,
    answer: "D. 清除遺漏的資料、將資料標準化、選取資料集中的資料行",
    rationale: "Azure Machine Learning 設計工具 (Designer) 提供拖放式視覺化介面來建立機器學習管線。使用流程：1) 建立管線 (Pipeline) 2) 訓練模型 3) 建立推斷管線 (Inference Pipeline) 4) 部署為端點。",
    examTip: "設計工具 = 拖放式 UI；管線 = 訓練流程；推斷管線 = 部署用的流程。",
    source: 1
  },
  {
    ...
    options: ["A. 影像分類", "B. 物件偵測 (Object Detection)", "C. 語意分割", "D. 臉部辨識"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 語意分割 (Semantic Segmentation)", "B. 影像分類", "C. 物件偵測", "D. 臉部辨識"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 機器學習", "B. 電腦視覺", "C. 自然語言處理", "D. 深度學習 (Deep Learning)"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 影像分類", "B. 物件偵測", "C. 光學字元辨識 (OCR)、空間分析", "D. 語意分割"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 機器學習", "B. 選擇模型、評估模型、定型模型", "C. 深度學習", "D. 電腦視覺"],
    subQuestions: null,
    answer: "B. 選擇模型、評估模型、定型模型",
  ...
  },
  {
    ...
    options: ["A. 信賴分數 (Confidence score)", "B. 機器學習", "C. 深度學習", "D. 電腦視覺"],
    subQuestions: null,
    answer: "A. 信賴分數 (Confidence score)",
    rationale: "此題考察電腦視覺服務。",
    examTip: "Azure AI 視覺服務包含 OCR、影像分析、空間分析。自訂視覺用於訓練專屬模型。",
    source: 1
  },
  {
    ...
    options: ["A. 標記 (Tagging)", "B. 機器學習", "C. 深度學習", "D. 電腦視覺"],
    subQuestions: null,
    answer: "A. 標記 (Tagging)",
    rationale: "此題考察電腦視覺服務。",
    examTip: "Azure AI 視覺服務包含 OCR、影像分析、空間分析。自訂視覺用於訓練專屬模型。",
  ...
  },
  {
    ...
    options: ["A. 機器學習", "B. 數位化醫療記錄 (從紙張文檔擷取文字)、可掃描手寫簽章的出席系統", "C. 深度學習", "D. 電腦視覺"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 影像分類", "B. 光學字元辨識 (OCR)", "C. 物件偵測", "D. 語意分割"],
    subQuestions: null,
    answer: "B. 光學字元辨識 (OCR)",
    rationale: "光學字元辨識 (OCR, Optical Character Recognition) 能夠從影像中讀取印刷和手寫文字。Azure AI 視覺服務的 OCR 功能可處理各種文件、收據、名片等。支援多種語言和字體。",
    examTip: "看到「從圖片讀取文字」、「手寫辨識」、「文件數位化」時，答案是 OCR。OCR 屬於電腦視覺！",
  ...
  },
  {
    ...
    options: ["A. 影像分類 (Image Classification)", "B. 迴歸", "C. 叢集", "D. 強化學習"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 機器學習", "B. 在欄位中追蹤牲畜", "C. 深度學習", "D. 電腦視覺"],
    subQuestions: null,
    answer: "B. 在欄位中追蹤牲畜",
    rationale: "物件偵測 (Object Detection) 不僅能識別影像中的物體類型，還能提供物體的位置資訊（周框方塊座標）。與影像分類不同，物件偵測可以識別同一影像中的多個物體並標示它們的位置。",
    examTip: "看到「位置」、「座標」、「周框方塊 (Bounding Box)」、「追蹤物體」時，答案是物件偵測。",
  ...
  },
  {
    ...
    options: ["A. 機器學習", "B. 深度學習", "C. 電腦視覺", "D. 名人 (Celebrities)、地標 (Landmarks)"],
    subQuestions: null,
    answer: "D. 名人 (Celebrities)、地標 (Landmarks)",
    rationale: "分類 (Classification) 是監督式學習演算法，用於將資料分配到預先定義的類別。二元分類（是/否、正/負）和多類別分類（A/B/C/D 等）。常見應用：垃圾郵件偵測、疾病診斷、影像識別。",
    examTip: "看到「類型」、「類別」、「分類」、「診斷」、「偵測」等詞時，答案是分類。分類 = 放入預定義的盒子。",
    source: 1
  },
  {
    ...
    options: ["A. 機器學習", "B. 深度學習", "C. 臉部偵測 (Face Detection)", "D. 電腦視覺"],
    subQuestions: null,
    answer: "C. 臉部偵測 (Face Detection)",
  ...
  },
  {
    ...
    options: ["A. 機器學習", "B. 臉部屬性 (Face Attributes)", "C. 深度學習", "D. 電腦視覺"],
    subQuestions: null,
    answer: "B. 臉部屬性 (Face Attributes)",
    rationale: "Azure AI 臉部服務 提供：1) 臉部偵測（找出臉的位置）2) 臉部屬性（年齡、情緒、眼鏡、頭飾等）3) 臉部驗證（一對一比對）4) 臉部識別（一對多比對）。",
    examTip: "年齡/情緒偵測 = 臉部屬性；確認是否同一人 = 臉部驗證；從資料庫找人 = 臉部識別。",
    source: 1
  },
  {
    ...
    options: ["A. 機器學習", "B. 深度學習", "C. 臉部識別 (Face Identification)、臉部驗證 (Face Verification)", "D. 電腦視覺"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 機器學習", "B. 深度學習", "C. Azure AI 自訂視覺 (Custom Vision)", "D. 電腦視覺"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 機器學習", "B. 身份證件模型 (ID document)、發票模型 (Invoice)", "C. 深度學習", "D. 電腦視覺"],
    subQuestions: null,
    answer: "B. 身份證件模型 (ID document)、發票模型 (Invoice)",
  ...
  },
  {
    ...
    options: ["A. 名片模型 (Business card)、發票模型", "B. 機器學習", "C. 深度學習", "D. 電腦視覺"],
    subQuestions: null,
    answer: "A. 名片模型 (Business card)、發票模型",
    rationale: "Azure AI 文件智慧 (Document Intelligence)（前身為表單辨識器）專門從文件中擷取結構化資料。提供預建模型：發票、收據、身份證件、名片、稅務文件等。也可訓練自訂模型處理特定表單格式。",
    examTip: "從「發票」、「護照」、「名片」等文件擷取資料 → 文件智慧服務。",
    source: 1
  },
  {
    ...
    options: ["A. 實體辨識", "B. 關鍵片語擷取", "C. 從商務深入解析報表擷取關鍵片語、在社交媒體數據上執行情感分析、翻譯不同語言與產品評論之間的文字", "D. 語言翻譯"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 分類標籤", "B. 特徵值", "C. 超參數", "D. 向量化 (Vectorization/Embeddings)"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 機器學習", "B. 詞幹分析/字幹 (Stemming)", "C. 深度學習", "D. 電腦視覺"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 機器學習", "B. 深度學習", "C. 電腦視覺", "D. 拿掉停用字詞 (Removing Stop Words)"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 情感分析", "B. 語言翻譯", "C. 關鍵片語擷取 (Key Phrase Extraction)、具名實體辨識 (Named Entity Recognition, NER)", "D. 語音辨識"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 情感分析", "B. 關鍵片語擷取", "C. 語言翻譯", "D. 具名實體辨識 (NER)"],
    subQuestions: null,
    answer: "D. 具名實體辨識 (NER)",
    rationale: "分類 (Classification) 是監督式學習演算法，用於將資料分配到預先定義的類別。二元分類（是/否、正/負）和多類別分類（A/B/C/D 等）。常見應用：垃圾郵件偵測、疾病診斷、影像識別。",
    examTip: "看到「類型」、「類別」、「分類」、「診斷」、「偵測」等詞時，答案是分類。分類 = 放入預定義的盒子。",
  ...
  },
  {
    ...
    options: ["A. 情感分析", "B. 關鍵片語擷取", "C. 語言翻譯", "D. 實體辨識 (含實體連結 Entity Linking)"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 實體辨識", "B. 關鍵片語擷取", "C. 情感分析 (Sentiment Analysis)", "D. 語言翻譯"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 機器學習", "B. ISO 639-1 程式代碼、語言名稱、分數 (Score)", "C. 深度學習", "D. 電腦視覺"],
    subQuestions: null,
    answer: "B. ISO 639-1 程式代碼、語言名稱、分數 (Score)",
  ...
  },
  {
    ...
    options: ["A. 機器學習", "B. 深度學習", "C. 電腦視覺", "D. NaN (Not a Number)"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. Azure Machine Learning", "B. Azure Cognitive Services", "C. Azure AI 語音 (Azure AI Speech)", "D. Azure Bot Service"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. Token 化 (Tokenization)", "B. 機器學習", "C. 深度學習", "D. 電腦視覺"],
    subQuestions: null,
    answer: "A. Token 化 (Tokenization)",
  ...
  },
  {
    ...
    options: ["A. 機器學習", "B. 語音服務 (Speech Service)、翻譯工具服務 (Translator)", "C. 深度學習", "D. 電腦視覺"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 機器學習", "B. 文字到文字 (Text-to-text)", "C. 深度學習", "D. 電腦視覺"],
    subQuestions: null,
    answer: "B. 文字到文字 (Text-to-text)",
    rationale: "此題考察自然語言處理功能。",
    examTip: "NER=找實體、關鍵片語=找主題、情感分析=判斷正負面。",
    source: 1
  },
  {
    ...
    options: ["A. 機器學習", "B. 深度學習", "C. 使用字典進行模型定型", "D. 電腦視覺"],
    subQuestions: null,
    answer: "C. 使用字典進行模型定型",
  ...
  },
  {
    ...
    options: ["A. 語言識別、人聲辨識 (Speaker Recognition)、語音助理、語音轉文字", "B. 機器學習", "C. 深度學習", "D. 電腦視覺"],
    subQuestions: null,
    answer: "A. 語言識別、人聲辨識 (Speaker Recognition)、語音助理、語音轉文字",
    rationale: "Azure AI 語音服務 提供：1) 語音轉文字 (STT) - 即時轉錄 2) 文字轉語音 (TTS) - 合成語音 3) 語音翻譯 4) 說話者辨識 - 識別說話人身份。STT 已針對對話和聽寫場景優化。",
    examTip: "「語音→文字」、「文字→語音」、「即時字幕」、「說話者識別」都是語音服務功能。",
    source: 1
  },
  {
    ...
    options: ["A. 機器學習", "B. 對話 (Conversational)、聽寫 (Dictation)", "C. 深度學習", "D. 電腦視覺"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 機器學習", "B. 深度學習", "C. Azure AI 服務 (Azure AI Services)", "D. 電腦視覺"],
    subQuestions: null,
    answer: "C. Azure AI 服務 (Azure AI Services)",
    rationale: "Azure AI 語音服務 提供：1) 語音轉文字 (STT) - 即時轉錄 2) 文字轉語音 (TTS) - 合成語音 3) 語音翻譯 4) 說話者辨識 - 識別說話人身份。STT 已針對對話和聽寫場景優化。",
    examTip: "「語音→文字」、「文字→語音」、「即時字幕」、「說話者識別」都是語音服務功能。",
    source: 1
  },
  {
    ...
    options: ["A. 機器學習", "B. Azure AI Bot Service", "C. 深度學習", "D. 電腦視覺"],
    subQuestions: null,
    answer: "B. Azure AI Bot Service",
  ...
  },
  {
    ...
    options: ["A. 機器學習", "B. 深度學習", "C. 網頁、現有的常見問題檔 (如 Doc, PDF)、手動輸入的數據", "D. 電腦視覺"],
    subQuestions: null,
    answer: "C. 網頁、現有的常見問題檔 (如 Doc, PDF)、手動輸入的數據",
    rationale: "此題考察自然語言處理功能。",
    examTip: "NER=找實體、關鍵片語=找主題、情感分析=判斷正負面。",
    source: 1
  },
  {
    ...
    options: ["A. 機器學習", "B. 深度學習", "C. 機器人服務 (Bot Service)、知識庫 (Knowledge Base)", "D. 電腦視覺"],
    subQuestions: null,
    answer: "C. 機器人服務 (Bot Service)、知識庫 (Knowledge Base)",
    rationale: "Azure AI Bot Service 是建立交談式 AI 的平台。機器人可連接多種通道 (Channels)：Teams、網頁聊天、Facebook、LINE 等。結合知識庫（如 QnA）可回答常見問題。Facebook 通道需要在該平台註冊應用程式。",
    examTip: "交談式 AI = Bot Service + 知識庫。記住：Facebook 通道需要額外註冊憑證。",
    source: 1
  },
  {
    ...
    options: ["A. 機器學習", "B. 臉書 (Facebook)", "C. 深度學習", "D. 電腦視覺"],
    subQuestions: null,
    answer: "B. 臉書 (Facebook)",
    rationale: "此題考察自然語言處理功能。",
    examTip: "NER=找實體、關鍵片語=找主題、情感分析=判斷正負面。",
    source: 1
  },
  {
    ...
    options: ["A. 回覆電子郵件問題、回覆常見問題 (FAQ)", "B. 機器學習", "C. 深度學習", "D. 電腦視覺"],
    subQuestions: null,
    answer: "A. 回覆電子郵件問題、回覆常見問題 (FAQ)",
    rationale: "此題考察自然語言處理功能。",
    examTip: "NER=找實體、關鍵片語=找主題、情感分析=判斷正負面。",
    source: 1
  },
  {
    ...
    options: ["A. Azure Machine Learning", "B. Azure Cognitive Services", "C. Azure OpenAI", "D. Azure Bot Service"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 監督式學習", "B. 電腦視覺", "C. 異常偵測", "D. 生成式 AI (Generative AI)"],
    subQuestions: null,
    answer: "D. 生成式 AI (Generative AI)",
  ...
  },
  {
    ...
    options: ["A. 電腦視覺", "B. 建立自然語言、瞭解自然語言", "C. 異常偵測", "D. 強化學習"],
    subQuestions: null,
    answer: "B. 建立自然語言、瞭解自然語言",
  ...
  },
  {
    ...
    options: ["A. Whisper", "B. DALL-E", "C. GPT-4", "D. Codex"],
    subQuestions: null,
    answer: "B. DALL-E",
    rationale: "生成式 AI (Generative AI) 能夠根據輸入提示創建新內容：文字、影像、音樂、程式碼等。不同於傳統 AI 只能分析或分類，生成式 AI 可以創造前所未有的內容。GPT 和 DALL-E 都是生成式 AI 模型。",
    examTip: "生成式 AI = 創造新內容的 AI。看到「產生」、「創建」、「生成」時選擇它。",
  ...
  },
  {
    ...
    options: ["A. 機器學習", "B. 深度學習", "C. 電腦視覺", "D. 建立影像的變化、編輯影像、建立新影像"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 自然語言處理", "B. 影像說明 (Image Captioning/Description) (這是電腦視覺的功能，非生成式繪圖)", "C. 異常偵測", "D. 強化學習"],
    subQuestions: null,
    answer: "B. 影像說明 (Image Captioning/Description) (這是電腦視覺的功能，非生成式繪圖)",
  ...
  },
  {
    ...
    options: ["A. 機器學習", "B. 深度學習", "C. 嵌入技術 (Embeddings)", "D. 電腦視覺"],
    subQuestions: null,
    answer: "C. 嵌入技術 (Embeddings)",
    rationale: "分類 (Classification) 是監督式學習演算法，用於將資料分配到預先定義的類別。二元分類（是/否、正/負）和多類別分類（A/B/C/D 等）。常見應用：垃圾郵件偵測、疾病診斷、影像識別。",
    examTip: "看到「類型」、「類別」、「分類」、「診斷」、「偵測」等詞時，答案是分類。分類 = 放入預定義的盒子。",
    source: 1
  },
  {
    ...
    options: ["A. 機器學習", "B. 副駕駛員 (Copilot)", "C. 深度學習", "D. 電腦視覺"],
    subQuestions: null,
    answer: "B. 副駕駛員 (Copilot)",
  ...
  },
  {
    ...
    options: ["A. 機器學習", "B. 深度學習", "C. 系統訊息 (System Message)", "D. 電腦視覺"],
    subQuestions: null,
    answer: "C. 系統訊息 (System Message)",
  ...
  },
  {
    ...
    options: ["A. 安全系統 (Safety System)", "B. 機器學習", "C. 深度學習", "D. 電腦視覺"],
    subQuestions: null,
    answer: "A. 安全系統 (Safety System)",
  ...
  },
  {
    ...
    options: ["A. 機器學習", "B. 深度學習", "C. 識別潛在的危害 (Identify)", "D. 電腦視覺"],
    subQuestions: null,
    answer: "C. 識別潛在的危害 (Identify)",
  ...
  },
  {
    ...
    options: null,
    subQuestions: [{"text": "1. 具名實體辨識可用來擷取文字字串中的日期與時間。", "answer": "是"}, {"text": "2. 關鍵片語擷取可用來擷取文件字串中的重要片語。", "answer": "是"}, {"text": "3. 關鍵片語擷取可用來擷取文件字串中的所有城市名稱。", "answer": "否"}],
    answer: "1. 是2. 是3. 否",
  ...
  },
  {
    ...
    options: ["1. 識別直播影片中的動物品種", "2. 建立訓練影片的縮圖", "3. 擷取手寫信件中的資料", "4. 擷取文件中的關鍵片語"],
    subQuestions: null,
    answer: "3. 擷取手寫信件中的資料",
  ...
  },
  {
    ...
    options: ["1. 將一些文件從英文翻譯成德文", "2. 辨識那些文件提供相同主題的資訊", "3. 辨識餐廳的評論為正面或負面", "4. 根據音軌為影片產生字幕"],
    subQuestions: null,
  ...
  },
  {
    ...
    question: "下列各項敘述如果成立，請選取 [是]；否則請選取 [否]。",
    options: null,
    subQuestions: [{"text": "1. 下列服務呼叫將接受英文文字做為輸入並且輸出法文和義大利文文字：`/translate?from=it&to=fr&to=en`", "answer": "否"}, {"text": "2. 下列服務呼叫將接受英文文字做為輸入並且輸出法文和義大利文文字：`/translate?from=en&to=fr&to=it`", "answer": "是"}, {"text": "3. 翻譯服務可用來將文件從英文翻譯為法文。", "answer": "是"}],
    answer: "1. 否2. 是3. 是",
  ...
  },
  {
    ...
    question: "下列各項敘述如果成立，請選取 [是]；否則請選取 [否]。",
    options: null,
    subQuestions: [{"text": "1. 聊天機器人只能使用自訂程式碼來建置。", "answer": "否"}, {"text": "2. Azure Bot Service 提供用於裝載交談式機器人的服務。", "answer": "是"}, {"text": "3. 使用 Azure Bot Service 建置的機器人可與 Microsoft Teams 使用者交流。", "answer": "是"}],
    answer: "1. 否2. 是3. 是",
  ...
  },
  {
    ...
    options: ["1. 自然語言處理 (NLP)", "2. 聊天機器人", "3. 機器學習", "4. 電腦視覺"],
    subQuestions: null,
    answer: "2. 聊天機器人",
  ...
  },
  {
    ...
    type: "single",
    question: "自然語言處理可用於：",
    options: ["1. 將 E-Mail 分類為工作郵件或個人郵件。", "2. 預測未來的租車數。", "3. 顯示溫度過高時停止工廠作業。", "4. 預測哪個網站的瀏覽者會執行交易。"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["1. Azure 認知搜尋", "2. Azure AI 語音", "3. Azure AI 翻譯工具", "4. Azure AI 語言"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["1. 翻譯", "2. 關鍵片語擷取", "3. 情感分析", "4. 實體辨識"],
    subQuestions: null,
    answer: "4. 實體辨識",
  ...
  },
  {
    ...
    options: ["1. 機器學習模型", "2. 聊天機器人", "3. 情感分析解決方案", "4. 電腦視覺應用程式"],
    subQuestions: null,
    answer: "2. 聊天機器人",
  ...
  },
  {
    ...
    options: ["1. 同時回答多位使用者的問題", "2. 登記客戶購買的商品", "3. 為客戶提供退貨授權 (RMA) 號", "4. 登記客訴內容"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["1. 使用電話鍵盤將信用卡號碼輸入到電話時，可以朗讀輸入號碼的自動語音。", "2. 可以用語音與玩家交談的電腦遊戲 AI 角色。", "3. 為新聞廣播產生即時字幕。", "4. 從會議錄音中擷取關鍵片語。"],
    subQuestions: null,
    answer: "1, 2",
  ...
  },
  {
    ...
    options: ["A. 機器學習", "B. 深度學習", "C. 1. (B. Azure AI 語音服務) - 將使用者的語音轉換為文字 2. (A. Azure AI 語言) - 識別使用者的意圖 3. (B. Azure AI 語音服務) - 向使用者提供口語回應", "D. 電腦視覺"],
    subQuestions: null,
    answer: "C. 1. (B. Azure AI 語音服務) - 將使用者的語音轉換為文字 2. (A. Azure AI 語言) - 識別使用者的意圖 3. (B. Azure AI 語音服務) - 向使用者提供口語回應",
  ...
  },
  {
    ...
    question: "下列各項敘述如果成立，請選取 [是]；否則請選取 [否]。",
    options: null,
    subQuestions: [{"text": "1. 聊天機器人可以支援語音輸入。", "answer": "是"}, {"text": "2. 每一種溝通管道都需要一個不同聊天機器人。", "answer": "否"}, {"text": "3. 聊天機器人可以結合自然語言及受限的回應選項來管理交談程序。", "answer": "是"}],
    answer: "1. 是2. 否3. 是",
  ...
  },
  {
    ...
    options: ["1. 語言模組化", "2. 翻譯", "3. 語音辨識", "4. 關鍵片語擷取"],
    subQuestions: null,
    answer: "2. 翻譯",
  ...
  },
  {
    ...
    options: ["A. 語言翻譯", "B. 語音辨識", "C. 語音合成", "D. A. (4. 情感分析) B. (2. 關鍵片語擷取) C. (1. 實體辨識)"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["1. 從預先定義的資料來源匯入閒聊內容。", "2. 手動輸入問題與答案。", "3. 將機器人連線到 Cortana 頻道，並們用 Cortana 提問。", "4. 從現有的網頁產生問題與答案。", "5. 使用 Azure Machine Learning 自動化 ML，根據包含問題與答案組的檔案來定型模型。"],
    subQuestions: null,
    answer: "1, 2, 4",
  ...
  },
  {
    ...
    options: ["1. Azure Health Bot", "2. Microsoft Bot Framework", "3. Power Virtual Agents"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["1. 規則運算式", "2. Pattern.any", "3. machine-learned", "4. 清單"],
    subQuestions: null,
    answer: "1. 規則運算式",
  ...
  },
  {
    ...
    options: ["1. Azure AI 翻譯工具", "2. Azure AI 語音", "3. Azure AI 語言", "4. Azure AI 文件智慧服務"],
    subQuestions: null,
  ...
  },
  {
    ...
    question: "下列各項敘述如果成立，請選取 [是]；否則請選取 [否]。",
    options: null,
    subQuestions: [{"text": "1. 您可以使用 Azure AI 語言服務的問題解答查詢 Azure SQL 資料庫。", "answer": "否"}, {"text": "2. 若您希望知識庫針對詢問類似問題的不同使用者，提供相同答案，則應該使用 Azure AI 語言服務的問題解答。", "answer": "是"}, {"text": "3. Azure AI 語言服務的問題解答可以判斷使用者語句的意圖。", "answer": "否"}],
    answer: "1. 否2. 是3. 否",
  ...
  },
  {
    ...
    question: "下列各項敘述如果成立，請選取 [是]；否則請選取 [否]。",
    options: null,
    subQuestions: [{"text": "1. Azure AI 語言服務可以識別文字是以何種語言撰寫。", "answer": "是"}, {"text": "2. Azure AI 語言服務可以偵測文件中的手寫簽名。", "answer": "否"}, {"text": "3. Azure AI 語言服務可以識別文件中所提及的公司和組織。", "answer": "是"}],
    answer: "1. 是2. 否3. 是",
  ...
  },
  {
    ...
    options: ["1. 物件偵測", "2. 下一個 Token 預測", "3. Token 化", "4. 內嵌計算", "5. 匿名化"],
    subQuestions: null,
    answer: "2, 3, 4",
  ...
  },
  {
    ...
    options: ["1. Azure AI 視覺", "2. Azure AI 語言", "3. Azure OpenAI", "4. Azure Machine Learning"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 迴歸", "B. A. (1. 分類) B. (2. 摘要) C. (3. 產生)", "C. 叢集", "D. 強化學習"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["1. GPT-3.5", "2. GPT-4", "3. DALL-E", "4. Codex"],
    subQuestions: null,
    answer: "3. DALL-E",
  ...
  },
  {
    ...
    options: ["1. GitHub Copilot", "2. GitHub 原始檔控制", "3. IntelliSense", "4. Microsoft 365 Copilot"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["1. 存在懲罰", "2. 停止序列", "3. 包含過去的訊息", "4. 回應上限"],
    subQuestions: null,
    answer: "1. 存在懲罰",
  ...
  },
  {
    ...
    question: "下列各項敘述如果成立，請選取 [是]；否則請選取 [否]。",
    options: null,
    subQuestions: [{"text": "1. 轉換器模型架構會使用自我注意力。", "answer": "是"}, {"text": "2. 轉換器模型架構包含編碼器區塊和解碼器區塊。", "answer": "是"}, {"text": "3. 轉換器模型架構包含加密區塊或解密區塊。", "answer": "否"}],
    answer: "1. 是2. 是3. 否",
  ...
  },
  {
    ...
    question: "下列各項敘述如果成立，請選取 [是]；否則請選取 [否]。",
    options: null,
    subQuestions: [{"text": "1. 您可以使用自己的資料微調 Azure OpenAI 模型。", "answer": "否"}, {"text": "2. 預先訓練的生成式 AI 模型是 Azure OpenAI 的元件。", "answer": "是"}, {"text": "3. 若要建置符合 Microsoft 負責任 AI 準則的解決方案，您必須建置和訓練自己的模型。", "answer": "否"}],
  ...
  },
  {
    ...
    options: ["1. GPT-3", "2. GPT-4", "3. DALL-E", "4. Codex"],
    subQuestions: null,
    answer: "3. DALL-E",
  ...
  },
  {
    ...
    options: ["1. 產生影像標題。", "2. 修改影像。", "3. 建立影像。", "4. 偵測影像中的物件。", "5. 使用光學字元辨識 (OCR)。"],
    subQuestions: null,
    answer: "2, 3",
  ...
  },
  {
    ...
    options: ["1. 適用於 Python 的 Azure SDK", "2. 適用於 JavaScript 的 Azure SDK", "3. Azure REST API", "4. Azure 命令列介面 (CLI)"],
    subQuestions: null,
    answer: "1, 3",
  ...
  },
  {
    ...
    options: ["1. Whisper", "2. GPT-4-32k", "3. microsoft-swinv2-base-patch4-window12-192-22k", "4. DALL-E"],
    subQuestions: null,
    answer: "2. GPT-4-32k",
  ...
  },
  {
    ...
    question: "下列各項敘述如果成立，請選取 [是]；否則請選取 [否]。",
    options: null,
    subQuestions: [{"text": "1. Azure OpenAI GPT-3.5 Turbo 模型可以將語音轉譯為文字。", "answer": "否"}, {"text": "2. Azure OpenAI DALL-E 模型會根據文字提示產生影像。", "answer": "是"}, {"text": "3. Azure OpenAI 內嵌文字模型可以根據文字相似性將文字轉換為數值向量。", "answer": "是"}],
    answer: "1. 否2. 是3. 是",
  ...
  },
  {
    ...
    options: ["1. 該聊天機器人將一律提供準確的資料。", "2. 該聊天機器人可能會使用不準確的資料回應。", "3. 基礎知識資料可用來限制聊天機器人的輸出。", "4. 該聊天機器人適合用來執行醫療診斷。"],
    subQuestions: null,
    answer: "2, 3",
  ...
  },
  {
    ...
    options: ["1. Azure OpenAI Whisper 模型", "2. Azure OpenAI DALL-E 模型", "3. Azure OpenAI GPT-4 模型", "4. GitHub Copilot 服務"],
    subQuestions: null,
    answer: "3, 4",
  ...
  },
  {
    ...
    options: ["1. Azure OpenAI Studio", "2. 文件智慧服務工作室", "3. ChatGPT", "4. GitHub Copilot"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["1. 微調", "2. 完成", "3. 基礎知識", "4. 提示工程"],
    subQuestions: null,
    answer: "1. 微調",
  ...
  },
  {
    ...
    options: ["1. 新增基礎知識資料", "2. 新增訓練資料", "3. 新增小樣本學習", "4. 修改系統訊息"],
    subQuestions: null,
    answer: "1. 新增基礎知識資料",
  ...
  },
  {
    ...
    options: ["1. 實作敏捷式軟體開發 (Agile Software Development) 方法", "2. 建立風險治理委員會，包括合法小組的成員、風險治理小組的成員、以及隱私保護專家。", "3. 防止洩漏使用 AI 演算法自動做出決策。", "4. 實作 AI 模型驗證的程序，做為軟體檢閱程序的一部分。"],
    subQuestions: null,
    answer: "2, 4",
  ...
  },
  {
    ...
    question: "下列各項敘述如果成立，請選取 [是]；否則請選取 [否]。",
    options: null,
    subQuestions: [{"text": "1. 根據歷史資料預測房價為異常偵測範例。", "answer": "否"}, {"text": "2. 在慣常模式中尋找偏差以識別可疑的登入為異常偵測範例。", "answer": "是"}, {"text": "3. 根據患者的病歷預測患者是否會罹患糖尿病為異常偵測範例。", "answer": "否"}],
    answer: "1. 否2. 是3. 否",
  ...
  },
  {
    ...
    options: ["1. 包容性", "2. 隱私權與安全性", "3. 可靠性與安全性", "4. 透明度"],
    subQuestions: null,
    answer: "3. 可靠性與安全性",
  ...
  },
  {
    ...
    options: ["1. 迴歸", "2. 自然語言處理", "3. 異常偵測", "4. 電腦視覺"],
    subQuestions: null,
    answer: "2. 自然語言處理",
  ...
  },
  {
    ...
    options: ["1. 自然語言處理", "2. 電腦視覺", "3. 知識探礦", "4. 異常偵測"],
    subQuestions: null,
    answer: "2. 電腦視覺",
  ...
  },
  {
    ...
    question: "下列各項敘述如果成立，請選取 [是]；否則請選取 [否]。",
    options: null,
    subQuestions: [{"text": "1. 監視線上服務的評論是否包含不雅用語為一項自然語言處理範例。", "answer": "是"}, {"text": "2. 辨識影像中品牌標誌為一項自然語言處理範例。", "answer": "否"}, {"text": "3. 監視公開新聞網站是否包含產品負面陳述為一項自然語言處理範例。", "answer": "是"}],
    answer: "1. 是2. 否3. 是",
  ...
  },
  {
    ...
    options: ["1. 決斷性", "2. 固執性", "3. 知識性", "4. 公平性", "5. 包容性", "6. 可靠性和安全性"],
    subQuestions: null,
    answer: "4, 5, 6",
  ...
  },
  {
    ...
    options: ["1. 監控機器溫度，以在溫度達到特定閾值時打開風扇。", "2. 可以回答諸如「今天天氣如何？」等問題的家用智慧型裝置。", "3. 自動將車前燈插入汽車的生產線機械。", "4. 使用知識庫以互動方式回答使用者問題的網站。"],
    subQuestions: null,
    answer: "2, 4",
  ...
  },
  {
    ...
    options: ["1. 隱私權與安全性", "2. 公平性", "3. 可靠性與安全性", "4. 透明度"],
    subQuestions: null,
    answer: "4. 透明度",
  ...
  },
  {
    ...
    options: ["1. 權責", "2. 公平性", "3. 隱私權與安全性", "4. 包容性"],
    subQuestions: null,
    answer: "4. 包容性",
  ...
  },
  {
    ...
    options: ["1. 權責性", "2. 公平性", "3. 包容性", "4. 透明度"],
    subQuestions: null,
    answer: "2. 公平性",
  ...
  },
  {
    ...
    options: ["A. 1. (6. 透明度) 2. (4. 隱私權和安全性) 3. (3. 包容性)", "B. 公平性", "C. 可靠性與安全性", "D. 隱私權與安全性"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["1. 電腦視覺工作負載。", "2. 知識採礦工作負載。", "3. 自然語言處理 (NLP) 工作負載。", "4. 生成式 AI 工作負載。"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["1. 確定定型資料集具有母體代表性。", "2. 啟用自動調整功能，以確保服務能根據需求調整。", "3. 提供文件以利開發人員偵錯程式碼。", "4. 確定所有視覺效果都有可供螢幕助讀程式讀取的相關聯文字。"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["1. AI 系統必須只能公開提供的資料。", "2. AI 系統必須保障公司的利益。", "3. AI 系統必須易於理解。", "4. AI 系統必須將個人詳細資料公開。"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["1. 異常偵測", "2. 電腦視覺", "3. 知識採礦", "4. 自然語言處理"],
    subQuestions: null,
    answer: "4. 自然語言處理",
  ...
  },
  {
    ...
    question: "下列各項敘述如果成立，請選取 [是]；否則請選取 [否]。",
    options: null,
    subQuestions: [{"text": "1. 會回答諸如「我的下一場約會是何時？」等問題的家用智慧型裝置為交談式 AI 的範例。", "answer": "是"}, {"text": "2. 公司網站上的互動式網路聊天功能可以使用 Azure Bot Service 實作。", "answer": "是"}, {"text": "3. 為預先錄製影片自動產生字幕是交談式 AI 的範例。", "answer": "否"}],
    answer: "1. 是2. 是3. 否",
  ...
  },
  {
    ...
    question: "下列各項敘述如果成立，請選取 [是]；否則請選取 [否]。",
    options: null,
    subQuestions: [{"text": "1. 您使用未標記的資料定型迴歸模型。", "answer": "否"}, {"text": "2. 分類技術用來預測一段時間後的連續數值。", "answer": "否"}, {"text": "3. 依共同特性分組項目為叢集範例。", "answer": "是"}],
    answer: "1. 否2. 否3. 是",
  ...
  },
  {
    ...
    options: ["1. 公平性", "2. 可靠性與安全性", "3. 權責性", "4. 包容性"],
    subQuestions: null,
    answer: "2. 可靠性與安全性",
  ...
  },
  {
    ...
    options: ["1. 異常偵測", "2. 自然語言處理", "3. 電腦視覺", "4. 知識採礦"],
    subQuestions: null,
    answer: "2. 自然語言處理",
  ...
  },
  {
    ...
    options: ["A. 1. (3. 叢集) 2. (2. 迴歸) 3. (1. 分類)", "B. 強化學習", "C. 監督式學習", "D. 非監督式學習"],
    subQuestions: null,
  ...
  },
  {
    ...
    question: "下列各項敘述如果成立，請選取 [是]；否則請選取 [否]。",
    options: null,
    subQuestions: [{"text": "1. 若為迴歸模型，標籤必須是數值。", "answer": "是"}, {"text": "2. 若為叢集模型，必須提供標籤。", "answer": "否"}, {"text": "3. 若為分類模型，標籤必須為數值。", "answer": "否"}],
    answer: "1. 是2. 否3. 否",
  ...
  },
  {
    ...
    options: ["1. 名字", "2. 姓氏", "3. 教育程度", "4. 收入範圍", "5. 年齡"],
    subQuestions: null,
    answer: "3, 5",
  ...
  },
  {
    ...
    options: null,
    subQuestions: [{"text": "1. 「質量(公斤)」為特徵。", "answer": "是"}, {"text": "2. 「品質測試」為標籤。", "answer": "是"}, {"text": "3. 「溫度(C)」為標籤。", "answer": "否"}],
    answer: "1. 是2. 是3. 否",
  ...
  },
  {
    ...
    question: "下列各項敘述如果成立，請選取 [是]；否則請選取 [否]。",
    options: null,
    subQuestions: [{"text": "1. Azure Machine Learning 設計工具提供拖放視覺效果畫布，以供建置、測試和部署機器學習模型。", "answer": "是"}, {"text": "2. Azure Machine Learning 設計工具可將進度儲存為管線草稿。", "answer": "是"}, {"text": "3. Azure Machine Learning 設計工具可併入自訂的 JavaScript 函式。", "answer": "否"}],
    answer: "1. 是2. 是3. 否",
  ...
  },
  {
    ...
    options: ["A. 標籤", "B. 參數", "C. 超參數", "D. A. (1. 特徵) B. (2. 標籤)"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["1. 用特徵進行訓練，標籤則用來進行評估。", "2. 用標籤進行訓練，特徵則用來進行評估。", "3. 將資料隨機分割為訓練資料行和評估資料行。", "4. 將資料隨機分割為訓練資料列和評估資料列。"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["1. 模型名稱", "2. REST 端點", "3. 驗證金鑰", "4. 定型端點"],
    subQuestions: null,
    answer: "2, 3",
  ...
  },
  {
    ...
    options: ["1. 將原始資料集分割成特徵和標籤資料集，使用特徵資料集進行評估。", "2. 將原始資料集分割成定型和測試資料集，使用測試資料集進行評估。", "3. 將原始資料集分割成定型和測試資料集，使用定型資料集進行評估。", "4. 使用原始資料集進行定型和評估。"],
    subQuestions: null,
  ...
  },
  {
    ...
    question: "下列各項敘述如果成立，請選取 [是]；否則請選取 [否]。",
    options: null,
    subQuestions: [{"text": "1. 自動化機器學習讓您能夠將自訂 Python 程式碼包含在訓練管線中。", "answer": "否"}, {"text": "2. 自動化機器學習實作機器學習解決方案無需程式設計經驗。", "answer": "是"}, {"text": "3. 自動化機器學習使您能夠在互動式畫布中以視覺方式連接資料集和模組。", "answer": "否"}],
    answer: "1. 否2. 是3. 否",
  ...
  },
  {
    ...
    options: ["1. 各計程車行程的車資", "2. 各計程車行程的單程距離", "3. 資料集中的計程車行程數", "4. 各計程車行程的單程 ID"],
    subQuestions: null,
  ...
  },
  {
    ...
    question: "下列各項敘述如果成立，請選取 [是]；否則請選取 [否]。",
    options: null,
    subQuestions: [{"text": "1. 根據不同使用量來統計資料分組文件為叢集範例。", "answer": "是"}, {"text": "2. 根據症狀和診斷測試結果分組相似病患為叢集範例。", "answer": "是"}, {"text": "3. 根據花粉計數預測某人會罹患輕度、中度還是嚴重的過敏症狀為叢集範例。", "answer": "否"}],
    answer: "1. 是2. 是3. 否",
  ...
  },
  {
    ...
    options: ["1. 選取資料集中的資料行", "2. 合併資料", "3. 分割資料", "4. 新增資料列"],
    subQuestions: null,
    answer: "3. 分割資料",
  ...
  },
  {
    ...
    options: ["1. Normalize Data (正常化資料) 模組", "2. Select Columns in Dataset (選取資料集中的資料行) 模組", "3. 資料集輸出視覺化特徵", "4. 評估結果視覺化特徵"],
    subQuestions: null,
    answer: "3. 資料集輸出視覺化特徵",
  ...
  },
  {
    ...
    options: ["A. 機器學習", "B. 深度學習", "C. 答案順序： 1, 5, 4, 2", "D. 電腦視覺"],
    subQuestions: null,
    answer: "C. 答案順序： 1, 5, 4, 2",
  ...
  },
  {
    ...
    options: ["1. 時間限制", "2. 特徵工程", "3. MLflow 模型", "4. 模型定型"],
    subQuestions: null,
    answer: "4. 模型定型",
  ...
  },
  {
    ...
    options: ["1. 布林值", "2. 日期時間", "3. 數值", "4. 文字"],
    subQuestions: null,
    answer: "3. 數值",
  ...
  },
  {
    ...
    options: ["1. AUC 計量", "2. 混淆矩陣", "3. ROC 曲線", "4. 閾值"],
    subQuestions: null,
    answer: "2. 混淆矩陣",
  ...
  },
  {
    ...
    options: ["1. 元件", "2. 資料集", "3. 管線", "4. Azure Machine Learning 作業"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["1. 在視覺效果畫布上新增與連結模組", "2. 自動執行一般資料準備工作", "3. 自動選取演算法以建置最精確的模型", "4. 使用 Code First 筆記本體驗"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["1. 將並行反覆運算上限設為 [0]。", "2. 啟用最佳解釋模型。", "3. 將驗證類型設為 [自動]。", "4. 將主要計量設為 [精確度]。"],
    subQuestions: null,
    answer: "2. 啟用最佳解釋模型。",
  ...
  },
  {
    ...
    options: ["1. 增加定型反覆運算的數目。", "2. 修改有利於錯誤否定的閾值。", "3. 修改有利於誤判為真的閾值。", "4. 在定型資料中納入測試資料。"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["1. Jupyter Notebook", "2. 已註冊的資料集", "3. Machine Learning 工作區", "4. Machine Learning 設計工具管線"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["1. Azure AI 電腦視覺服務中的 [描述影像] 作業", "2. 臉部服務中的 [偵測] 作業", "3. Azure AI 電腦視覺服務中的 [分析影像] 作業", "4. 臉部服務中的 [驗證] 作業"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 分類", "B. A. (4. 選取資料集中的資料行) B. (3. 線性迴歸) C. (6. 評分模型) (注意：原始答案 B-5, C-6 有誤，已根據標準流程修正)", "C. 叢集", "D. 強化學習"],
    subQuestions: null,
  ...
  },
  {
    ...
    type: "single",
    question: "您使用自動化機器學習使用者介面 (UI) 建置機器學習模型。您必須確保此模型符合 Microsoft 責任 AI 的透明度準則。試問您應該如何做？",
    options: ["1. 解釋模型。", "2. 註冊模型。", "3. 佈建推斷叢集。", "4. 註冊訓練資料。"],
    subQuestions: null,
    answer: "1. 解釋模型。",
  ...
  },
  {
    ...
    options: ["1. 臉部", "2. Azure AI 文件智慧服務", "3. Azure AI 電腦視覺", "4. Azure AI 語言"],
    subQuestions: null,
    answer: "1. 臉部",
  ...
  },
  {
    ...
    options: ["1. 影像分類", "2. 影像描述", "3. 物件偵測", "4. 光學字元辨識 (OCR)"],
    subQuestions: null,
    answer: "3. 物件偵測",
  ...
  },
  {
    ...
    options: ["1. 影像分類", "2. 影像處理", "3. 物件偵測", "4. 光學字元辨識 (OCR)"],
    subQuestions: null,
    answer: "4. 光學字元辨識 (OCR)",
  ...
  },
  {
    ...
    options: ["1. 臉部辨識", "2. 物件偵測", "3. 光學字元辨識 (OCR)", "4. 影像分類"],
    subQuestions: null,
    answer: "3. 光學字元辨識 (OCR)",
  ...
  },
  {
    ...
    options: ["1. 影像分類", "2. 物件偵測", "3. 光學字元辨識 (OCR)", "4. 臉部辨識"],
    subQuestions: null,
    answer: "3. 光學字元辨識 (OCR)",
  ...
  },
  {
    ...
    options: ["A. 迴歸", "B. 叢集", "C. 強化學習", "D. A. (1. 影像分類) B. (3. 光學字元辨識) C. (2. 物件偵測)"],
    subQuestions: null,
  ...
  },
  {
    ...
    question: "下列各項敘述如果成立，請選取 [是]；否則請選取 [否]。",
    options: null,
    subQuestions: [{"text": "1. 物件偵測可以識別影像中受損產品的位置。", "answer": "是"}, {"text": "2. 物件偵測可以識別影像中受損產品的多個實例。", "answer": "是"}, {"text": "3. 物件偵測可以識別影像中多種類型的受損產品。", "answer": "否"}],
  ...
  },
  {
    ...
    options: ["1. 預測", "2. 異常偵測", "3. 知識採礦", "4. 電腦視覺"],
    subQuestions: null,
    answer: "4. 電腦視覺",
  ...
  },
  {
    ...
    options: ["1. Azure OpenAI 服務", "2. Azure AI 視覺", "3. 交談語言理解 (CLU)", "4. Azure Machine Learning"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["1. 臉部分析", "2. 物件偵測", "3. 影像分類", "4. 光學字元辨識"],
    subQuestions: null,
    answer: "2. 物件偵測",
  ...
  },
  {
    ...
    options: ["1. 將影像中的文字翻譯為不同語言。", "2. 辨識手寫文字。", "3. 訓練自訂影像分類模型。", "4. 偵測影像中臉部。"],
    subQuestions: null,
    answer: "2, 4",
  ...
  },
  {
    ...
    options: ["1. Azure AI 電腦視覺", "2. Azure AI 自訂視覺服務", "3. Azure AI 文件智慧服務", "4. 媒體用影片分析器"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["1. Azure AI 電腦視覺空間分析", "2. Azure AI 自訂視覺物件偵測", "3. Azure AI 電腦視覺影像分析", "4. Azure AI 自訂視覺分類"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["1. 臉部辨識", "2. 物件偵測", "3. 影像分類", "4. 光學字元辨識"],
    subQuestions: null,
    answer: "1. 臉部辨識",
  ...
  },
  {
    ...
    options: ["1. 從發票中擷取發票號碼", "2. 根據收據辨識零售商", "3. 在目錄中尋找產品影像", "4. 將表格從法文翻譯成英文"],
    subQuestions: null,
    answer: "1, 2",
  ...
  },
  {
    ...
    options: ["1. 偵測影像中的色彩配置。", "2. 將文字翻譯為不同語言。", "3. 擷取關鍵詞組。", "4. 預測股票價格。", "5. 偵測影像中的商標。"],
    subQuestions: null,
    answer: "1, 5",
  ...
  },
  {
    ...
    options: ["1. Azure AI 自訂視覺", "2. Azure AI 文件智慧服務", "3. 交談語言理解"],
    subQuestions: null,
    answer: "3. 交談語言理解",
  ...
  },
  {
    ...
    options: ["1. Azure AI 電腦視覺", "2. 交談語言理解", "3. Azure AI 自訂視覺", "4. Azure AI 文件智慧服務"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["1. Azure AI 文件智慧服務", "2. Azure AI 電腦視覺", "3. 臉部", "4. Azure AI 自訂視覺"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["1. Azure AI 電腦視覺", "2. Azure AI 自訂視覺", "3. Azure AI 文件智慧服務", "4. Azure AI 語言"],
    subQuestions: null,
  ...
  },
  {
    ...
    type: "single",
    question: "電腦視覺功能可部署來？",
    options: ["1. 為網站部署文字聊天機器人。", "2. 識別線上商店的異常客戶行為。", "3. 將臉部辨識功能整合到應用程式。", "4. 建議對內送電子郵件的自動化回覆。"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["1. 5MB", "2. 10 MB", "3. 50 MB", "4. 100 MB"],
    subQuestions: null,
    answer: "3. 50 MB",
  ...
  },
  {
    ...
    options: ["A. 表格辨識器 (Form Recognizer / Document Intelligence)", "B. 文字分析", "C. 自訂視覺", "D. Language Understanding (LUIS)"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 文字 (Text)", "B. 影片", "C. 影像 (Image)", "D. 音訊"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 設定內容篩選設定", "B. 自訂大型語言模型 (LLM)", "C. 變更 Azure OpenAI 服務使用的模型", "D. 設定系統提示"],
    subQuestions: null,
    answer: "A. 設定內容篩選設定",
  ...
  },
  {
    ...
    options: ["A. Copilot", "B. ML 管線", "C. DALL-E", "D. 自動化機器學習 (自動 ML)"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 混淆矩陣", "B. 準確度", "C. 精確度", "D. 召回率"],
    subQuestions: null,
    answer: "A. 混淆矩陣",
  ...
  },
  {
    ...
    options: ["A. 透過檢查使用者標記的大量電子郵件來識別垃圾郵件的子類型", "B. 根據歷史資料、房屋大小和房屋的臥室數目預測房屋的銷售價格", "C. 根據學生的年齡及其教育成就資料集中學生的資料", "D. 透過分析影像來識別瀕危動物的數量"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 迴歸", "B. 二元分類", "C. 叢集", "D. 多類別分類"],
    subQuestions: null,
    answer: "C. 叢集",
  ...
  },
  {
    ...
    options: ["A. Azure Machine Learning", "B. Azure AI 視覺", "C. Azure AI Foundry 服務", "D. Azure AI 自訂視覺"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. AI 系統應該保障開發人員的利益", "B. AI 系統應該使用單獨模型", "C. AI 系統應該公平待人", "D. AI 系統不應該透露其設計細節"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. Azure AI 沉浸式閱讀程式", "B. Azure OpenAI", "C. Azure AI 文件智慧服務", "D. Azure AI 搜尋服務"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 公平性", "B. 透明度", "C. 隱私權和安全性", "D. 包容性"],
    subQuestions: null,
    answer: "C. 隱私權和安全性",
  ...
  },
  {
    ...
    options: ["A. 學習率", "B. 溫度", "C. 批次大小", "D. 迭代次數"],
    subQuestions: null,
    answer: "B. 溫度",
  ...
  },
  {
    ...
    options: ["A. 新增訓練資料", "B. 修改系統訊息", "C. 新增小樣本學習", "D. 新增基礎知識資料"],
    subQuestions: null,
    answer: "D. 新增基礎知識資料",
  ...
  },
  {
    ...
    options: ["A. 分類標籤", "B. 特徵值", "C. 超參數", "D. 內嵌"],
    subQuestions: null,
    answer: "D. 內嵌",
  ...
  },
  {
    ...
    options: ["A. 自動將車前燈插入汽車的生產線機械", "B. 監控機器溫度，以在溫度達到特定閾值時打開風扇", "C. 使用知識庫以互動方式回答使用者問題的網站", "D. 可以回答諸如「今天天氣如何？」等問題的家用智慧型裝置"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. microsoft-swinv2-base-patch4-window12-192-22k", "B. Whisper", "C. DALL-E", "D. GPT-4-32k"],
    subQuestions: null,
    answer: "B. Whisper",
  ...
  },
  {
    ...
    options: ["A. 自然語言處理", "B. 異常偵測", "C. 強化學習", "D. 1. - 擷取檔案格式及欄位資料(A. Azure AI 文件智慧擷取服務) 2. - 辨識來自多種檔案格式之圖像及可視資料的資訊(B. 電腦視覺) 3. - 傳回撰寫完整段落文字的回應(C. 生成式 AI) 4. - 擷取與主題最相關的資料(D. 知識探索)"],
    subQuestions: null,
    answer: "D. 1. - 擷取檔案格式及欄位資料(A. Azure AI 文件智慧擷取服務) 2. - 辨識來自多種檔案格式之圖像及可視資料的資訊(B. 電腦視覺) 3. - 傳回撰寫完整段落文字的回應(C. 生成式 AI) 4. - 擷取與主題最相關的資料(D. 知識探索)",
  ...
  },
  {
    ...
    options: ["A. 1. - 兩張臉部相片是同一個人嗎？(C. 驗證 Verify) 2. - 這個人看起來像其他人嗎？(B. 相似度 Find Similar) 3. - 這群人中的這個人是誰？(A. 識別 Identify)", "B. 機器學習", "C. 深度學習", "D. 電腦視覺"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 取得完全隨機的定型樣本 (training sample)。", "B. 取得代表英國人口的定型樣本。", "C. 從資料中移除受保護特性 (protected characteristics) 的相關資料，然後再進行取樣。", "D. 使用全球保險公司的資料建立定型資料集 (training dataset)。"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: null,
    subQuestions: [{"text": "會回答諸如「我的下一場約會是何時?」等問題的家用智慧型裝置", "answer": "是"}, {"text": "公司網站上的互動式網路聊天", "answer": "是"}, {"text": "為預先錄製影片自動產生字幕", "answer": "否"}],
  ...
  },
  {
    ...
    options: ["A. 將驗證類型 (validation type) 設置為 [Auto]。", "B. 將並行反覆運算上限設為 [0]。", "C. 將主要計量 (primary metric) 設為 [Accuracy]。", "D. 啟用最佳解釋模型 (Enable model explainability)。"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 自然語言處理 (NLP)", "B. 電腦視覺 (Computer Vision)", "C. 交談式 AI (Conversational AI)", "D. 異常偵測 (Anomaly Detection)"],
    subQuestions: null,
    answer: "A. 自然語言處理 (NLP)",
  ...
  },
  {
    ...
    options: ["A. 強化學習", "B. 1. - 根據機場降雪量預測航班延誤時分數 (A. 迴歸 Regression) 2. - 將客戶劃分為不同群組以支援行銷部門 (B. 叢集 Clustering) 3. - 預測學生是否能完成大學課程 (C. 分類 Classification)", "C. 監督式學習", "D. 非監督式學習"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 同時回答多位使用者的問題。", "B. 登記客訴內容。", "C. 登記客戶購買的商品。", "D. 為客戶提供退貨授權 (RMA) 編號。"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 自然語言處理 (NLP)", "B. 電腦視覺", "C. 異常偵測", "D. 強化學習"],
    subQuestions: null,
    answer: "A. 自然語言處理 (NLP)",
  ...
  },
  {
    ...
    question: "在下列每一項敘述中，如果敘述成立，請選取 [是]。否則，請選取 [否]。 注意：每答對一個選項，可得一分。",
    options: null,
    subQuestions: [{"text": "標記", "answer": "是"}, {"text": "您應該使用訓練模型", "answer": "否"}, {"text": "精確度 (Precision", "answer": "否"}],
  ...
  },
  {
    ...
    options: ["A. 在視覺效果畫布新增元件", "B. 機器學習", "C. 深度學習", "D. 電腦視覺"],
    subQuestions: null,
    answer: "A. 在視覺效果畫布新增元件",
  ...
  },
  {
    ...
    options: ["A. 使用 QnA Maker 擷取文件並建立知識庫。", "B. 使用知識庫部署機器人。", "C. 在 QnA Maker 入口網站中，建置機器人。", "D. 使用文字分析擷取檔並建立知識庫。"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 透過電子郵件接受問題，然後根據訊息內容將該電子郵件訊息路由傳送給正確人員。", "B. 計算在網站上輸入音樂會評論為正面或負面，然後在這些評論中加入讚或怒的表情圖示。", "C. 將客戶在 kiosk 輸入的問題翻譯成英文，以便相關人員可以回電給客戶。", "D. 在網站介面中，回答有關音樂節的預定活動與購票等常見問題。"],
    subQuestions: null,
  ...
  },
  {
    ...
    question: "在下列每一項敘述中，如果敘述成立，請選取 [是]。否則，請選取 [否]。 注意：每答對一個選項，可得一分。",
    options: null,
    subQuestions: [{"text": "餐廳可以透過 Cortana", "answer": "是"}, {"text": "餐廳可以利用聊天機器人", "answer": "是"}, {"text": "餐廳可以利用聊天機器人", "answer": "否"}],
  ...
  },
  {
    ...
    options: ["A. 建立多回合問題", "B. 新增閒聊 (Chit-chat)", "C. 提高回應的信賴等級閾值", "D. 啟用主動學習"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 回應上限 (max_tokens)", "B. 停止序列 (stop)", "C. 存在懲罰 (presence_penalty)", "D. 包含過去的訊息"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. Azure Machine Learning Designer", "B. Azure Notebooks", "C. 1. - 建立 Machine Learning 工作區 (Workspace) (A. Azure 入口網站) 2. - 使用專用的拖放功能介面來定型及部署模型 (B. Machine Learning 設計工具) 3. - 使用精靈來選取機器學習執行設定 (C. 自動化機器學習)", "D. Azure ML SDK"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. AI 系統必須只使用公開提供的資料。", "B. AI 系統必須保障公司的利益。", "C. AI 系統必須將個人詳細資料公開。", "D. AI 系統必須易於理解。"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. DALL-E", "B. Whisper", "C. GPT-4", "D. OpenAI Codex"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 準確度", "B. 1. - 檢查混淆矩陣的值 (A. 模型評估) 2. - 將日期分割成 [年]、[月] 和 [日] 欄位 (B. 特徵工程) 3. - 挑選訓練氣候模型的溫度和壓力 (C. 特徵選取)", "C. 精確度", "D. 召回率"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 臉部辨識", "B. 光學字元辨識(OCR)", "C. 物件偵測 (Object Detection)", "D. 影像分類"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 特徵 (Feature)", "B. 標籤", "C. 參數", "D. 超參數"],
    subQuestions: null,
    answer: "A. 特徵 (Feature)",
  ...
  },
  {
    ...
    options: ["A. 情感分析", "B. 語音辨識", "C. 實體辨識 (Entity Recognition)", "D. 關鍵片語擷取"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 資料集中的計程車行程數", "B. 個別計程車行程的單程距離", "C. 個別計程車行程的車資 (fare)", "D. 個別計程車行程的單程識別碼"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 迴歸 (Regression)", "B. 叢集", "C. 分類"],
    subQuestions: null,
    answer: "A. 迴歸 (Regression)",
  ...
  },
  {
    ...
    question: "在下列每一項敘述中，如果敘述成立，請選取 [是]。否則，請選取 [否]。 注意：每答對一個選項，可得一分。",
    options: null,
    subQuestions: [{"text": "您可以使用自己的資料微調 Azure OpenAI", "answer": "是"}, {"text": "預先訓練的生成式 AI", "answer": "是"}, {"text": "若要建置符合 Microsoft 負責任 AI", "answer": "否"}],
  ...
  },
  {
    ...
    options: ["A. 公平性", "B. 隱私權與安全性", "C. 包容性 (Inclusiveness)", "D. 權責"],
    subQuestions: null,
  ...
  },
  {
    ...
    question: "在下列每一項敘述中，如果敘述成立，請選取 [是]。否則，請選取 [否]。 注意：每答對一個選項，可得一分。",
    options: null,
    subQuestions: [{"text": "網路聊天機器人", "answer": "是"}, {"text": "為預先錄製影片自動產生字幕", "answer": "否"}, {"text": "可以回答諸如「今天天氣如何？」等問題的家用智慧型裝置", "answer": "是"}],
  ...
  },
  {
    ...
    options: ["A. 根據使用者所提供影像，針對物件加以分類的機器學習技術。", "B. 根據影像內容，針對該影像加以分類的機器學習技術。", "C. 可隨時間分析資料並識別異常變化的機器學習技術。", "D. 能夠理解畫面及語音的機器學習技術。"],
    subQuestions: null,
  ...
  },
  {
    ...
    question: "在下列每一項敘述中，如果敘述成立，請選取 [是]。否則，請選取 [否]。 注意：每答對一個選項，可得一分。",
    options: null,
    subQuestions: [{"text": "自動化機器學習", "answer": "是"}, {"text": "自動化機器學習", "answer": "否"}, {"text": "自動化機器學習", "answer": "是"}, {"text": "自動化機器學習", "answer": "否"}],
  ...
  },
  {
    ...
    options: null,
    subQuestions: [{"text": "您可以使用語言服務", "answer": "否"}, {"text": "若您希望知識庫", "answer": "是"}, {"text": "語言服務", "answer": "否"}],
  ...
  },
  {
    ...
    options: ["A. 預測時間序列 => 使用多類別或多標籤分類，僅根據文字資料類型預測。", "B. 迴歸 (Regression) => 預測連續數值。", "C. 電腦視覺 (預覽) => 多類別或多標籤影像分類，物件偵測和執行個體分割。", "D. 分類 => 預測目標資料行中的數個類別之：是/否、藍色、紅色、綠色。", "E. 自然語言處理 (預覽) => 根據時間預測值。"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 找出感興趣的區域。", "B. 偵測物件。", "C. 辨識文字。", "D. 描述影像 (Image Description / Captioning)。"],
    subQuestions: null,
  ...
  },
  {
    ...
    question: "在下列每一項敘述中，如果敘述成立，請選取 [是]。否則，請選取 [否]。 注意：每答對一個選項，可得一分。",
    options: null,
    subQuestions: [{"text": "回應內部使用者查詢的機器人", "answer": "是"}, {"text": "顯示與輸入搜尋字詞相關影像的應用程式為自然語言處理", "answer": "是"}, {"text": "用來提交重設密碼要求的 web", "answer": "否"}],
  ...
  },
  {
    ...
    options: ["A. 佈建推斷叢集", "B. 解釋模型", "C. 註冊模型 (Register Model)", "D. 註冊訓練資料"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 可靠性與安全性", "B. 1. - 系統不得基於性別、種族或年齡產生歧視。 (A. 公平性) 2. - 只有已核准使用者可以看見個人資料。 (B. 隱私和安全性) 3. - 自動決策程序必須加以記錄，以便已核准使用者可以識別決策制定原因。 (D. 透明度)", "C. 隱私權與安全性", "D. 包容性"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 語言服務 (Language service)", "B. Azure Bot Service", "C. 表格辨識器 (Form Recognizer)", "D. 異常偵測器 (Anomaly Detector)"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 建立風險治理委員會,包括合法小組的成員、風險治理小組的成員,以及隱私保護專員。", "B. 實作 AI 模型驗證的程式，做為軟體檢閱程式的一部分。", "C. 防止洩漏使用 AI 演算法自動做出決策。", "D. 實作敏捷式軟體開發 (Agile Software Development) 方法。"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 自訂視覺 (Custom Vision)", "B. 交談語言理解 (CLU)", "C. 表格辨識器 (Form Recognizer)"],
    subQuestions: null,
    answer: "B. 交談語言理解 (CLU)",
  ...
  },
  {
    ...
    options: ["A. 答案 (正確順序)： 內嵌及準備資料集。 將資料隨機分割為訓練資料與驗證資料... 定型模型。 對原始資料集評估模型。 (更準確地說，是對「驗證/測試資料集」評估模型)", "B. 分類標籤", "C. 特徵值", "D. 超參數"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 1. - 用以預測數值的受監督機器學習模型 (A. 迴歸) 2. - 用以預測類別的受監督機器學習模型 (B. 分類) 3. - 用以根據特徵將相似實體分組的不受監督機器學習模型 (C. 叢集)", "B. 強化學習", "C. 監督式學習", "D. 非監督式學習"],
    subQuestions: null,
  ...
  },
  {
    ...
    question: "在下列每一項敘述中，如果敘述成立，請選取 [是]。否則，請選取 [否]。 注意：每答對一個選項，可得一分。",
    options: null,
    subQuestions: [{"text": "監視線上服務的評論是否包含不雅用語為一項自然語言處理", "answer": "是"}, {"text": "辨識影像中品牌標誌為一項自然語言處理", "answer": "否"}, {"text": "監視公用新聞網站是否包含產品負面陳述為一項自然語言處理", "answer": "是"}],
  ...
  },
  {
    ...
    options: ["A. 確保儲存使用者特殊權限資料的方式安全無虞", "B. 協助使用者瞭解 AI 系統所做的決定", "C. 確保開發人員為其建立的解決方案負責", "D. 確保所有申請人都有相同的機會"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 安全", "B. 可靠性", "C. 公平性 (Fairness)", "D. 隱私權和安全性"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 機器學習", "B. 預測 (Prediction / Forecasting)", "C. 深度學習", "D. 電腦視覺"],
    subQuestions: null,
    answer: "B. 預測 (Prediction / Forecasting)",
  ...
  },
  {
    ...
    options: ["A. 迴歸", "B. 叢集", "C. 1. - 檢測小說作品的類型。 (A. 分類) 2. - 根據文字輸入建立重點清單。 (C. 摘要) 3. - 根據產品描述建立廣告標語。 (B. 產生)", "D. 強化學習"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 電腦視覺 (Computer Vision)", "B. 表格辨識器 (Form Recognizer)", "C. 臉部 (Face)", "D. 自訂視覺 (Custom Vision)"],
    subQuestions: null,
    answer: "A. 電腦視覺 (Computer Vision)",
  ...
  },
  {
    ...
    options: ["A. 物件偵測", "B. 臉部偵測", "C. 影像分類", "D. 光學字元辨識 (OCR)"],
    subQuestions: null,
    answer: "D. 光學字元辨識 (OCR)",
  ...
  },
  {
    ...
    options: ["A. 機器學習", "B. 深度學習", "C. 電腦視覺", "D. 標記 (Labeling)"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. Azure Bot Service", "B. 文字分析", "C. 語言服務 (Language Service)", "D. 翻譯工具"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 果斷性 (Decisiveness)", "B. 公平性", "C. 可靠性和安全性", "D. 包容性"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 迴歸 (Regression)", "B. 聚集 (Clustering)", "C. 分類", "D. 知識採礦 (Knowledge Mining)"],
    subQuestions: null,
    answer: "A. 迴歸 (Regression)",
  ...
  },
  {
    ...
    options: ["A. 機器學習", "B. 深度學習", "C. 電腦視覺", "D. 1. - 將使用者的語音轉換為文字。 (B. Azure AI 語音) 2. - 識別使用者的意圖。 (C. Azure AI 語言服務) 3. - 向使用者提供口語回應。 (B. Azure AI 語音)"],
    subQuestions: null,
    answer: "D. 1. - 將使用者的語音轉換為文字。 (B. Azure AI 語音) 2. - 識別使用者的意圖。 (C. Azure AI 語言服務) 3. - 向使用者提供口語回應。 (B. Azure AI 語音)",
  ...
  },
  {
    ...
    options: ["A. 電腦視覺應用程式", "B. 聊天機器人 (Chatbot)", "C. 情感分析解決方案", "D. 機器學習模型"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 機器學習", "B. 深度學習", "C. 類神經語音 (Neural voice) (題目中可能譯為「中性語音」)", "D. 電腦視覺"],
    subQuestions: null,
    answer: "C. 類神經語音 (Neural voice) (題目中可能譯為「中性語音」)",
  ...
  },
  {
    ...
    options: ["A. 光學字元辨識(OCR)", "B. 影像分類", "C. 物件偵測", "D. 語意分割"],
    subQuestions: null,
    answer: "A. 光學字元辨識(OCR)",
  ...
  },
  {
    ...
    options: ["A. 迴歸 (Regression)", "B. 分類", "C. 叢集 (Clustering，題目為蓄集，應為叢集)"],
    subQuestions: null,
    answer: "A. 迴歸 (Regression)",
  ...
  },
  {
    ...
    options: ["A. 機器學習", "B. 深度學習", "C. 電腦視覺", "D. 正確預測肯定的有： 11 (True Positives) 錯誤否定的有： 0 (False Negatives)"],
    subQuestions: null,
    answer: "D. 正確預測肯定的有： 11 (True Positives) 錯誤否定的有： 0 (False Negatives)",
  ...
  },
  {
    ...
    options: ["A. 回歸", "B. 分類 (Classification)", "C. 聚集 (Clustering)"],
    subQuestions: null,
    answer: "B. 分類 (Classification)",
  ...
  },
  {
    ...
    options: ["A. 公平性", "B. 1. - 確定 AI 系統能依原始設計運行，回應未預期的狀況，以及拒絕有害的操控。 (A. 可靠性與安全性) 2. - 實施處理程式，以確保人類可覆寫 AI 系統制定的決策。 (B. 權責) 3. - 為消費者提供資訊，使其得以控制對資料的收集、使用和儲存。 (C. 隱私權和安全性)", "C. 隱私權與安全性", "D. 包容性"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 語音 (Speech)", "B. Language Understanding (LUIS)", "C. 翻譯工具", "D. 文字分析"],
    subQuestions: null,
    answer: "A. 語音 (Speech)",
  ...
  },
  {
    ...
    options: ["A. Azure AI Vision", "B. Azure AI Language", "C. 表格辨識器 (Form Recognizer)", "D. Azure AI Speech"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 迴歸", "B. 將電子郵件分類為工作相關或個人相關", "C. 叢集", "D. 強化學習"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: null,
    subQuestions: [{"text": "臉部服務", "answer": "是"}, {"text": "若您提供每位員工更多不同角度的範例相片，臉部服務", "answer": "是"}, {"text": "若員工戴著墨鏡，臉部服務", "answer": "否"}],
  ...
  },
  {
    ...
    options: ["A. 1. - 可使用自然語言來查詢知識庫。 (B. 語言服務) 2. - 可進行語音轉換文字的即時轉錄。 (C. 語音)", "B. 電腦視覺", "C. 異常偵測", "D. 強化學習"],
    subQuestions: null,
    answer: "A. 1. - 可使用自然語言來查詢知識庫。 (B. 語言服務) 2. - 可進行語音轉換文字的即時轉錄。 (C. 語音)",
  ...
  },
  {
    ...
    options: ["A. 分類", "B. 聚集 (Clustering)", "C. 迴歸 (Regression)"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 透明度 (Transparency)", "B. 包容性", "C. 權責", "D. 公平性"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 電腦視覺", "B. Azure AI 文件智慧 (前身為表格辨識器)", "C. 臉部 (Face)", "D. Azure AI 語言"],
    subQuestions: null,
    answer: "C. 臉部 (Face)",
  ...
  },
  {
    ...
    options: ["A. 調整數值變數，將它們保持在一致的數值範圍內", "B. 建立定型和驗證資料集", "C. 選取必須包含在模型中的資料列", "D. 轉移具有缺少資料的記錄"],
    subQuestions: null,
    answer: "B. 建立定型和驗證資料集",
  ...
  },
  {
    ...
    options: ["A. 固執性", "B. 知識性", "C. 決斷性", "D. 公平性 (Fairness)", "E. 包容性 (Inclusiveness)", "F. 可靠性和安全性 (Reliability and Safety)"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 關鍵片語擷取", "B. 翻譯", "C. 情感分析", "D. 實體辨識 (Entity Recognition)"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 分析 (Analysis)", "B. 機器學習", "C. 深度學習", "D. 電腦視覺"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 驗證 (Validation)", "B. 機器學習", "C. 深度學習", "D. 電腦視覺"],
    subQuestions: null,
    answer: "A. 驗證 (Validation)",
  ...
  },
  {
    ...
    question: "在下列每一項敘述中，如果敘述成立，請選取 [是]。否則，請選取 [否]。 注意：每答對一個選項，可得一分。",
    options: null,
    subQuestions: [{"text": "解釋信用貸款應用程式的結果為 Microsoft 責任 AI", "answer": "是"}, {"text": "依傷害排列保險理賠優先順序的分級機器人為 Microsoft 責任 AI", "answer": "否"}, {"text": "按不同銷區域的不同定價所提供的 AI", "answer": "否"}],
  ...
  },
  {
    ...
    question: "在下列每一項敘述中，如果敘述成立，請選取 [是]。否則，請選取 [否]。 注意：每答對一個選項，可得一分。",
    options: null,
    subQuestions: [{"text": "您使用未標記", "answer": "否"}, {"text": "分類", "answer": "否"}, {"text": "依共用特性分組項目為叢集 (Clustering", "answer": "是"}],
  ...
  },
  {
    ...
    options: ["A. REST 端點 (Endpoint)", "B. 模型名稱", "C. 訓練端點", "D. 驗證金鑰 (Authentication Key)"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 選取資料集中的資料行", "B. 分割資料 (Split Data)", "C. 合併資料", "D. 新增資料列"],
    subQuestions: null,
  ...
  },
  {
    ...
    question: "在下列每一項敘述中，如果敘述成立，請選取 [是]。否則，請選取 [否]。 注意：每答對一個選項，可得一分。",
    options: null,
    subQuestions: [{"text": "若為遞歸模型", "answer": "是"}, {"text": "若為叢集模型", "answer": "否"}, {"text": "若為分類模型", "answer": "否"}],
  ...
  },
  {
    ...
    options: ["A. 機器學習", "B. 異常偵測 (Anomaly Detection)", "C. 深度學習", "D. 電腦視覺"],
    subQuestions: null,
    answer: "B. 異常偵測 (Anomaly Detection)",
  ...
  },
  {
    ...
    question: "在下列每一項敘述中，如果敘述成立，請選取 [是]。否則，請選取 [否]。 注意：每答對一個選項，可得一分。",
    options: null,
    subQuestions: [{"text": "驗證集", "answer": "否"}, {"text": "驗證集", "answer": "是"}, {"text": "驗證集", "answer": "否"}],
  ...
  },
  {
    ...
    options: ["A. 使用原始資料集進行定型和評估。", "B. 將原始資料集分割成特徵資料集和標籤資料集。使用特徵資料集進行評估。", "C. 將原始資料集分割成定型資料集和測試資料集。使用定型資料集進行評估。", "D. 將原始資料集分割成定型資料集和測試資料集。使用測試資料集進行評估。"],
    subQuestions: null,
  ...
  },
  {
    ...
    question: "在下列每一項敘述中，如果敘述成立，請選取 [是]。否則，請選取 [否]。 注意：每答對一個選項，可得一分。",
    options: null,
    subQuestions: [{"text": "自訂視覺", "answer": "是"}, {"text": "自訂視覺", "answer": "是"}, {"text": "自訂視覺", "answer": "否"}],
  ...
  },
  {
    ...
    options: ["A. 自然語言處理", "B. 異常偵測", "C. 電腦視覺", "D. 知識採礦 (Knowledge Mining)"],
    subQuestions: null,
    answer: "A. 自然語言處理",
  ...
  },
  {
    ...
    options: ["A. 自然語言處理 (NLP)", "B. 異常偵測", "C. 電腦視覺", "D. 知識採礦 (Knowledge Mining)"],
    subQuestions: null,
    answer: "D. 知識採礦 (Knowledge Mining)",
  ...
  },
  {
    ...
    options: ["A. 標籤", "B. 特徵工程 (Feature Engineering)", "C. 參數", "D. 超參數"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. Jupyter Notebook", "B. 已註冊模型", "C. 計算資源 (Compute Resource)"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 動態條幅中的物件。", "B. 產生影像標題。", "C. 修改影像 (Edit Image / Inpainting/Outpainting)。", "D. 建立影像 (Generate Image)。", "E. 使用光學字元辨識 (OCR)。"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 語言翻譯", "B. 1. - 根據支援報修中所包含文字瞭解客戶的不滿意程度 (A. 情感分析) 2. - 彙總支援報修中重要資訊 (C. 關鍵片語擷取) 3. - 從支援報修中擷取關鍵日期 (B. 實體辨識)", "C. 語音辨識", "D. 語音合成"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 匯出模型", "B. 建立新的模型", "C. 建立預先建置工作實體", "D. 將語句新增至「無 (None)」意圖 (Intent)"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 工作 1: 實體辨識 (Entity Recognition) 工作 2: 情感分析 (Sentiment Analysis)", "B. 關鍵片語擷取", "C. 語言翻譯", "D. 語音辨識"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 使用其他機器學習模型。", "B. 增加訓練資料量。", "C. 調整閾值 (Adjust the threshold)。", "D. 增加定型反覆運算的數目。"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 5 MB", "B. 100 MB", "C. 10 MB", "D. 50 MB"],
    subQuestions: null,
    answer: "D. 50 MB",
  ...
  },
  {
    ...
    options: ["A. 自訂模型比預建模型便宜。", "B. 只有自訂模型可以部署在內部部署環境。", "C. 自訂模型一律提供更高的精確度。", "D. 自訂模型可加以訓練來辨識各種表格類型。"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 語義分段", "B. 影像分類", "C. 臉部辨識", "D. 光學字元辨識 (OCR)"],
    subQuestions: null,
    answer: "D. 光學字元辨識 (OCR)",
  ...
  },
  {
    ...
    options: ["A. 建立電話或會議的文字紀錄", "B. 為錄製或直播影片提供隱藏式輔助字幕", "C. 為火車站建立自動廣播系統", "D. 可大聲朗讀文字訊息的車載系統"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 翻譯和關鍵詞語摘取", "B. 語音辨識和實體辨識", "C. 語音辨識和語言模型", "D. 翻譯和情感分析"],
    subQuestions: null,
    answer: "A. 翻譯和關鍵詞語摘取",
  ...
  },
  {
    ...
    options: ["A. 電腦視覺", "B. 異常偵測", "C. 自然語言處理 (NLP)", "D. 回歸"],
    subQuestions: null,
    answer: "C. 自然語言處理 (NLP)",
  ...
  },
  {
    ...
    type: "single",
    question: "分類的使用案例為何？",
    options: ["A. 根據過去的賽跑時間，預測某人此次賽跑所需的分鐘數。", "B. 分析影像內容並將具有相似色彩的影像分組。", "C. 根據某人前一晚的睡眠時數，預測其喝的咖啡杯數。", "D. 根據住家到工作地點的距離，預測某人是否騎自行車上班。"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 將影像中的文字翻譯為不同語言", "B. 訓練自訂影像分類模型", "C. 偵測影像中臉部", "D. 辨識手寫文字"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 包容性", "B. 可靠性和安全性", "C. 透明度", "D. 隱私權和安全性 (Privacy and Security)"],
    subQuestions: null,
  ...
  },
  {
    ...
    question: "在下列每一項敘述中，如果敘述成立，請選取 [是]。否則，請選取 [否]。 注意：每答對一個選項，可得一分。",
    options: null,
    subQuestions: [{"text": "轉換器模型", "answer": "是"}, {"text": "轉換器模型", "answer": "是"}, {"text": "轉換器模型", "answer": "否"}],
  ...
  },
  {
    ...
    question: "在下列每一項敘述中，如果敘述成立，請選取 [是]。否則，請選取 [否]。 注意：每答對一個選項，可得一分。",
    options: null,
    subQuestions: [{"text": "Azure Machine Learning 設計工具", "answer": "是"}, {"text": "Azure Machine Learning 設計工具", "answer": "是"}, {"text": "Azure Machine Learning 設計工具", "answer": "否"}],
  ...
  },
  {
    ...
    options: ["A. Azure Machine Learning", "B. Azure AI 電腦視覺", "C. Azure 認知服務 (Azure Cognitive Services)", "D. Azure AI 自訂視覺"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 1. - 即使發生意外情況，AI 系統也必須始終如一地按預期運作。 (A. 可靠性和安全性) 2. - AI 系統必須保護及保障個人與企業資訊。 (B. 隱私權和安全性)", "B. 公平性", "C. 透明度", "D. 包容性"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 答案 (依序使用模組)： 選取資料集中的資料行 (Select Columns in Dataset) 分割資料 (Split Data) 線性迴歸 (Linear Regression) (註：一個完整的訓練管線還需要「訓練模型」和「評分模型」及「評估模型」元件，但題目只要求完成此模型的「三種」模組類型)", "B. 分類", "C. 叢集", "D. 強化學習"],
    subQuestions: null,
  ...
  },
  {
    ...
    type: "single",
    question: "下列哪一項敘述是 Microsoft 責任 AI 準則的範例？",
    options: ["A. AI 系統必須保障公司的利益。", "B. AI 系統必須透明且包容。", "C. AI 系統必須只使用公開提供的資料。", "D. AI 系統必須將個人資料公開。"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 從預先定義的資料來源匯入問聊內容。", "B. 手動輸入問題和答案。", "C. 從現有的網頁產生問題與答案。", "D. 使用 Azure Machine Learning 自動化 ML，根據包含問題與答案例的檔案來定型模型。", "E. 將機器人連線至 Cortana 頻道，並使用 Cortana 提出問題。"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 機器學習", "B. 深度學習", "C. 電腦視覺", "D. 臉部分析 (Face Analysis)"],
    subQuestions: null,
    answer: "D. 臉部分析 (Face Analysis)",
  ...
  },
  {
    ...
    options: null,
    subQuestions: [{"text": "“質量(kg)”是特徵 (Feature", "answer": "是"}, {"text": "“質量測試”是標籤 (Label", "answer": "是"}, {"text": "“溫度(C)”是標籤 (Label", "answer": "否"}],
  ...
  },
  {
    ...
    question: "在下列每一項敘述中，如果敘述成立，請選取 [是]。否則，請選取 [否]。 注意：每答對一個選項，可得一分。",
    options: null,
    subQuestions: [{"text": "您可以使用 Cortana", "answer": "是"}, {"text": "您可以使用 Microsoft Teams", "answer": "是"}, {"text": "您可以使用網頁聊天", "answer": "是"}],
  ...
  },
  {
    ...
    options: ["A. 家庭收入： 功能 (Feature) 房價類別： 標籤 (Label)", "B. 特徵", "C. 參數", "D. 輸出層"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 影像分類", "B. 臉部偵測", "C. 光學字元辨識 (OCR)", "D. 物件偵測 (Object Detection)"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 圖像 (Image) (此選項不標準，應指 Computer Vision)", "B. 臉部", "C. 表格識別器 (Form Recognizer / Document Intelligence)", "D. 自訂視覺"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 臉部服務中的[驗證]作業", "B. 臉部服務中的[偵測 (Detect)]作業", "C. 電腦視覺服務中的[分析影像 (Analyze Image)]作業", "D. 電腦視覺服務中的[描述影像 (Describe Image)]作業"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 機器學習", "B. Microsoft Bot Framework", "C. 深度學習", "D. 電腦視覺"],
    subQuestions: null,
    answer: "B. Microsoft Bot Framework",
  ...
  },
  {
    ...
    options: ["A. 回歸", "B. 分類 (Classification)", "C. 叢集 (Clustering)"],
    subQuestions: null,
    answer: "B. 分類 (Classification)",
  ...
  },
  {
    ...
    options: ["A. 確定所有視覺效果都有可供編輯程式讀取的相關聯文字。", "B. 提供文件以利開發人員偵錯程式碼。", "C. 確定訓練資料集具有母體代表性。", "D. 嚴用自動調整功能，以確保服務能根據需求調整。"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 使用數字鍵盤將信用卡號碼輸入到電話時，可以朗讀號碼的自動語音", "B. 從會議錄音中提取關鍵片語", "C. 為新聞廣播產生即時字幕", "D. 可以用語音與玩家交談的電腦遊戲 AI 角色"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 召回率 (Recall)", "B. 準確度", "C. 精確度", "D. F1分數"],
    subQuestions: null,
    answer: "A. 召回率 (Recall)",
  ...
  },
  {
    ...
    options: ["A. 模型訓練", "B. 特徵選取", "C. 特徵工程 (Feature Engineering)", "D. 模型評估"],
    subQuestions: null,
    answer: "C. 特徵工程 (Feature Engineering) (以PDF答案為準，但有爭議)",
  ...
  },
  {
    ...
    options: ["A. 權責性", "B. 可靠性和安全性", "C. 包容性 (Inclusiveness)", "D. 公平性"],
    subQuestions: null,
    answer: "C. 包容性 (Inclusiveness)",
  ...
  },
  {
    ...
    options: ["A. 標籤", "B. 1. - 合併多個來源資料 (C. 資料擷取和準備) 2. - 根據驗證資料計算模型效能 (B. 模型評估) 3. - 移除包含遺失資料或不相關資料其資料行 (A. 特徵工程和選取)", "C. 參數", "D. 超參數"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 文字擷取 (Text Extraction / OCR)", "B. 影像分類", "C. 物件偵測", "D. 語意分割"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 情感分析", "B. 具名實體辨識(NER)", "C. 關鍵片語擷取", "D. 語言翻譯"],
    subQuestions: null,
    answer: "B. 具名實體辨識(NER)",
  ...
  },
  {
    ...
    options: ["A. PDF", "B. ZIP", "C. JPEG", "D. PPTX"],
    subQuestions: null,
    answer: "A. PDF",
  ...
  },
  {
    ...
    options: ["A. Jupyter Notebook", "B. Machine Learning 設計工具管線", "C. 已註冊的資料集", "D. Machine Learning 工作區 (Workspace)"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 機器學習", "B. 電腦視覺", "C. 聊天機器人 (Chatbot)", "D. 自然語言處理 (NLP)"],
    subQuestions: null,
    answer: "C. 聊天機器人 (Chatbot)",
  ...
  },
  {
    ...
    options: ["A. 影像分類", "B. 語意分割", "C. 1. - 識別影像中名人 (A. 臉部辨識) 2. - 擷取電影海報影像中電影名稱 (B. 光學字元辨識) 3. - 找到影像中車輛 (C. 物件偵測)", "D. OCR"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. Azure AI Vision", "B. Azure AI Language", "C. Azure AI Speech", "D. 表格識別器 (Form Recognizer / Document Intelligence)"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 為了使用未用於訓練模型的資料來測試模型", "B. 為了訓練模型兩次以取得更好的精確度", "C. 為了同時訓練多個模型以取得更好的效能"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 1. - 識別手寫字體 (A. 電腦視覺) 2. - 預測社交媒體貼文的情感 (B. 自然語言處理) 3. - 識別異常信用卡付款 (C. 異常偵測) 4. - 根據多個尺寸將動物分組 (D. 機器學習（叢集）)", "B. 迴歸", "C. 分類", "D. 強化學習"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 適用於 JavaScript 的 Azure SDK", "B. Azure 命令列介面(CLI)", "C. 適用於 Python 的 Azure SDK", "D. Azure REST API"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 根據音軌為影片產生字幕", "B. 辨識哪些檔提供相同主題的資訊", "C. 辨識餐廳的評論為正面或負面", "D. 將一些文件從英文翻譯成德文"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. Azure AI 電腦視覺", "B. Azure AI 文件智慧", "C. Azure AI 自訂視覺 (Custom Vision)", "D. 臉部"],
    subQuestions: null,
    answer: "C. Azure AI 自訂視覺 (Custom Vision)",
  ...
  },
  {
    ...
    type: "single",
    question: "識別電話號碼時，會使用哪種類型的自然語言處理 (NLP)實體？",
    options: ["A. 規則運算式 (Regular Expression)", "B. machine-learned", "C. Pattern.any", "D. 清單"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 建立叢集模型。", "B. 將資料分割成訓練與測試資料集。", "C. 取資料集。", "D. 建立分類模型。"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 模組 (Module)", "B. 計算", "C. 管線", "D. 資料集 (Dataset)"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 自然語言處理 (NLP)", "B. 異常偵測 (Anomaly Detection)", "C. 知識採礦", "D. 電腦視覺"],
    subQuestions: null,
    answer: "B. 異常偵測 (Anomaly Detection)",
  ...
  },
  {
    ...
    options: ["A. 情感分析", "B. 語音辨識 (Speech Recognition)", "C. 實體辨識", "D. 關鍵片語擷取"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 清理資料之後。", "B. 使用驗證資料測試模型之後。", "C. 定型模型之際。", "D. 選擇模型的類型之前。"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 名字", "B. 年齡", "C. 姓氏", "D. 教育程度", "E. 收入範圍"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 迴歸 (Regression)", "B. 分類", "C. 聚集 (Clustering)"],
    subQuestions: null,
    answer: "A. 迴歸 (Regression)",
  ...
  },
  {
    ...
    question: "在下列每一項敘述中，如果敘述成立，請選取 [是]。否則，請選取 [否]。 注意：每答對一個選項，可得一分。",
    options: null,
    subQuestions: [{"text": "根據文件內容字的相似性分組文件為叢集", "answer": "是"}, {"text": "根據症狀和診斷測試結果分組相似患者為叢集", "answer": "是"}, {"text": "根據花粉計數預測某人會罹患輕度、中度還是嚴重的過敏症狀為叢集", "answer": "否"}],
  ...
  },
  {
    ...
    options: ["A. 公平性", "B. 包容性", "C. 隱私和安全性", "D. 透明度 (Transparency)"],
    subQuestions: null,
    answer: "D. 透明度 (Transparency)",
  ...
  },
  {
    ...
    options: ["A. 語言理解功能", "B. 電腦視覺影像分析功能", "C. 自訂視覺影像分類功能", "D. Azure 搜尋功能中的 AI 擴充"],
    subQuestions: null,
    answer: "B. 電腦視覺影像分析功能",
  ...
  },
  {
    ...
    options: ["A. 機器學習", "B. 深度學習", "C. 電腦視覺", "D. 異常偵測工作負載 (Anomaly Detection Workload)"],
    subQuestions: null,
    answer: "D. 異常偵測工作負載 (Anomaly Detection Workload)",
  ...
  },
  {
    ...
    options: ["A. 產品可靠性提升", "B. 銷售額增加", "C. 客戶服務代理人的工作量下降"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 強化學習", "B. 監督式學習", "C. 1. - 根據人口統計資料為乘客指派類別。 (A. 叢集) 2. - 根據飛行距離預測消耗的燃油量。 (B. 迴歸) 3. - 根據人口統計資料預測乘客是否會錯過他們的航班。 (C. 分類)", "D. 非監督式學習"],
    subQuestions: null,
  ...
  },
  {
    ...
    question: "在下列每一項敘述中，如果敘述成立，請選取 [是]。否則，請選取 [否]。 注意：每答對一個選項，可得一分。",
    options: null,
    subQuestions: [{"text": "自動化機器學習", "answer": "否"}, {"text": "自動化機器學習", "answer": "是"}, {"text": "自動化機器學習", "answer": "否"}],
  ...
  },
  {
    ...
    options: ["A. 臉部偵測和臉部辨識 (Face Detection and Recognition)", "B. 語意分析", "C. 影像分析", "D. 光學字元辨識(OCR)"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 機器學習", "B. 深度學習", "C. 模型定型 (Model Training)", "D. 電腦視覺"],
    subQuestions: null,
    answer: "C. 模型定型 (Model Training)",
  ...
  },
  {
    ...
    question: "在下列每一項敘述中，如果敘述成立，請選取 [是]。否則，請選取 [否]。 注意；每答對一個選項，可得一分。",
    options: null,
    subQuestions: [{"text": "您可以透過使用電子郵件與機器人", "answer": "是"}, {"text": "您可以透過使用 Microsoft Teams", "answer": "是"}, {"text": "您可以透過使用網頁網路聊天", "answer": "是"}],
  ...
  },
  {
    ...
    options: ["A. 語言理解", "B. 語音", "C. QnA Maker", "D. Azure Bot Service"],
    subQuestions: null,
  ...
  },
  {
    ...
    question: "在下列每一項敘述中，如果敘述成立，請選取 [是]。否則，請選取 [否]。 注意：每答對一個選項，可得一分。",
    options: null,
    subQuestions: [{"text": "實體辨識", "answer": "是"}, {"text": "關鍵片語擷取", "answer": "是"}, {"text": "關鍵片語擷取", "answer": "否"}],
  ...
  },
  {
    ...
    type: "single",
    question: "您需要預測某個區域的動物族群規模。 您應該使用下列哪一種 Azure Machine Learning 類型？",
    options: ["A. 蓄集 (應為叢集)", "B. 分類", "C. 迴歸 (Regression)"],
    subQuestions: null,
    answer: "C. 迴歸 (Regression)",
  ...
  },
  {
    ...
    question: "在下列每一項敘述中，如果敘述成立，請選取 [是]。否則，請選取 [否]。 注意：每答對一個選項，可得一分。",
    options: null,
    subQuestions: [{"text": "聊天機器人", "answer": "是"}, {"text": "每一種溝通管道都需要一個不同聊天機器人", "answer": "否"}, {"text": "聊天機器人", "answer": "是"}],
  ...
  },
  {
    ...
    options: ["A. 機器學習", "B. 深度學習", "C. 確判為假 (False Negative)", "D. 電腦視覺"],
    subQuestions: null,
    answer: "C. 確判為假 (False Negative)",
  ...
  },
  {
    ...
    options: ["A. 聚集 (Clustering)", "B. 分析", "C. 迴歸 (Regression)"],
    subQuestions: null,
    answer: "C. 迴歸 (Regression)",
  ...
  },
  {
    ...
    options: ["A. 語言偵測", "B. 情感分析", "C. 實體辨識", "D. 關鍵片語提取 (Key Phrase Extraction)"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 根據語音路由傳送通話。", "B. 將語音通話轉錄為文字。", "C. 合併多個通話。", "D. 根據成本路由傳送通話。"],
    subQuestions: null,
    answer: "B. 將語音通話轉錄為文字。",
  ...
  },
  {
    ...
    options: ["A. [ ] 使用模型為測試數據進行評分。", "B. [x] 移除具有缺失值的記錄。", "C. [x] 合併多個資料集。", "D. [ ] 計算模型的精準度。", "E. [ ] 使用即時預測的模型。"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 影像分類", "B. 物件偵測", "C. 光學字元辨識(OCR) (假設描述來自影像中的文字)", "D. 語意分割"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. [ ] 在目錄中尋找產品影像。", "B. [x] 根據收據辨識零售商。", "C. [x] 從發票中擷取發票號碼。", "D. [ ] 將表格從法文翻譯成英文。"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. Token 化 (Tokenization)", "B. 下一個 Token 預測 (Next Token Prediction)", "C. 姓名化", "D. 內嵌計算 (Embedding Calculation)", "E. 物件偵測"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 翻譯工具", "B. 自訂視覺", "C. 臉部", "D. 語言服務 (Language Service)"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 迴歸", "B. 分類", "C. 叢集 (Clustering)", "D. 強化學習"],
    subQuestions: null,
  ...
  },
  {
    ...
    type: "single",
    question: "以下何者可用來根據使用者提供的句子完成段落？",
    options: ["A. Azure AI 視覺", "B. Azure OpenAI", "C. Azure AI 語言 (Language)", "D. Azure Machine Learning"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. Azure Bot Service", "B. 文字分析", "C. 表格辨識器", "D. 翻譯工具"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 物件偵測 (Object Detection)", "B. 臉部偵測", "C. 影像分類", "D. 光學字元符辨識 (OCR)"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 叢集 (Clustering)", "B. 迴歸", "C. 分類"],
    subQuestions: null,
  ...
  },
  {
    ...
    question: "在下列每一項敘述中，如果敘述成立，請選取 [是]。否則，請選取 [否]。 注意：每答對一個選項，可得一分。",
    options: null,
    subQuestions: [{"text": "物件偵測", "answer": "是"}, {"text": "物件偵測", "answer": "是"}, {"text": "物件偵測", "answer": "是"}],
  ...
  },
  {
    ...
    question: "在下列每一項敘述中，如果敘述成立，請選擇 [是]。否則，請選擇 [否]。 注意：每答對一個選項，可得一分。",
    options: null,
    subQuestions: [{"text": "下列服務呼叫將接受英文文字做為輸入並且輸出義大利文和法文文字。/translate?from=it&to=fr&to=en", "answer": "否"}, {"text": "下列服務呼叫將接受英文文字做為輸入並且輸出義大利文和法文文字。translate?from=en&to=fr&to=it", "answer": "是"}, {"text": "翻譯工具", "answer": "是"}],
  ...
  },
  {
    ...
    options: ["A. 交談式 AI", "B. 電腦視覺 (Computer Vision)", "C. 自然語言處理", "D. 異常偵測"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 使用臨床資料驗證模型", "B. 使用臨床資料訓練模型。", "C. 將臨床資料分割成兩個資料集。", "D. 使用自動化機器學習(Automated ML)訓練模型。"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 實體辨識", "B. 關鍵片段抽取 (Key Phrase Extraction)", "C. 翻譯", "D. 語言檢測"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 輸取手寫信件中的資料", "B. 建立訓練影片的縮圖", "C. 輸取文件中的關鍵字語", "D. 識別直播影片中的動物品種"],
    subQuestions: null,
    answer: "A. 輸取手寫信件中的資料",
  ...
  },
  {
    ...
    options: ["A. 自然語言處理", "B. 電腦視覺 (Computer Vision)", "C. 異常偵測", "D. 強化學習"],
    subQuestions: null,
    answer: "B. 電腦視覺 (Computer Vision)",
  ...
  },
  {
    ...
    options: ["A. 關鍵片語提取", "B. 情感分析", "C. 商務邏輯", "D. 主動式學習 (Active Learning)"],
    subQuestions: null,
  ...
  },
  {
    ...
    question: "在下列每一項敘述中，如果敘述成立，請選取 [是]。否則，請選取 [否]。 注意；每答對一個選項，可得一分。",
    options: null,
    subQuestions: [{"text": "您可以使用翻譯工具", "answer": "是"}, {"text": "您可以使用翻譯工具", "answer": "是"}, {"text": "您可以使用翻譯工具", "answer": "否"}],
  ...
  },
  {
    ...
    options: ["A. 語言模組化", "B. 翻譯", "C. 具名實體辨識 (NER)", "D. 情感分析"],
    subQuestions: null,
    answer: "C. 具名實體辨識 (NER)",
  ...
  },
  {
    ...
    type: "single",
    question: "您需要根據使用者提示產生影像。 您應該使用下列哪一個 Azure OpenAI 模型？",
    options: ["A. GPT-4", "B. Codex", "C. DALL-E", "D. GPT-3"],
    subQuestions: null,
    answer: "C. DALL-E",
  ...
  },
  {
    ...
    question: "在下列每一項敘述中，如果敘述成立，請選取 [是]。否則，請選取 [否]。 注意：每答對一個選項，可得一分。",
    options: null,
    subQuestions: [{"text": "根據歷史資料預測房價為異常偵測", "answer": "否"}, {"text": "在異常模式中尋找偏差以識別可疑的登入為異常偵測", "answer": "是"}, {"text": "根據患者的病歷預測患者是否會罹患糖尿病為異常偵測", "answer": "否"}],
  ...
  },
  {
    ...
    options: ["A. 領域", "B. 表達 (Utterance)", "C. 實體", "D. 意圖"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 均方根誤差 (RMSE)", "B. 平衡精準度", "C. 曲線下面積 (AUC)", "D. 決定係數 (R-squared / R²)", "E. F1 分數"],
    subQuestions: null,
  ...
  },
  {
    ...
    question: "在下列每一項敘述中，如果敘述成立，請選取[是]，否則，請選取[否]。 注意：每答對一個選項，可得一分。",
    options: null,
    subQuestions: [{"text": "Azure AI", "answer": "是"}, {"text": "Azure AI", "answer": "否"}, {"text": "Azure AI", "answer": "是"}],
  ...
  },
  {
    ...
    options: ["A. 關鍵片語顯取", "B. 實體辨識 (Entity Recognition)", "C. 語言偵測", "D. 語音辨識"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 電腦視覺", "B. 1. - 回答退款及換貨問題的自動化聊天機器人 (A. 知識採礦) 2. - 判斷相片中是否有人 (B. 電腦視覺) 3. - 判斷評論為正面或負面 (C. 自然語言處理)", "C. 異常偵測", "D. 強化學習"],
    subQuestions: null,
    answer: "B. 1. - 回答退款及換貨問題的自動化聊天機器人 (A. 知識採礦) 2. - 判斷相片中是否有人 (B. 電腦視覺) 3. - 判斷評論為正面或負面 (C. 自然語言處理)",
  ...
  },
  {
    ...
    options: ["A. Azure AI 電腦視覺空間分析", "B. Azure AI 電腦視覺影像分析", "C. Azure AI 自訂視覺物件偵測", "D. Azure AI 自訂視覺分類"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 將臉部辨識功能整合", "B. 影像分類", "C. 物件偵測", "D. 語意分割"],
    subQuestions: null,
    answer: "A. 將臉部辨識功能整合",
  ...
  },
  {
    ...
    options: ["A. 1. - 從文字中擷取人員、位置與組織 (A. 實體辨識) 2. - 沿著正負態度評估文字 (B. 情感分析) 3. - 將文字轉換為不同語言 (C. 翻譯)", "B. 關鍵片語擷取", "C. 語言翻譯", "D. 語音辨識"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. [ ] 語言模型", "B. [x] 關鍵片語提取", "C. [ ] 文字轉換語音", "D. [x] 語音轉換文字", "E. [ ] 翻譯"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 光學字元辨識 (OCR)", "B. 影像分類", "C. 物件偵測 (Object Detection)", "D. 臉部偵測"],
    subQuestions: null,
    answer: "C. 物件偵測 (Object Detection)",
  ...
  },
  {
    ...
    options: ["A. 交談式 Language Understanding", "B. 翻譯工具", "C. Azure 認知搜尋", "D. 語音"],
    subQuestions: null,
  ...
  },
  {
    ...
    question: "在下列每一項敘述中，如果敘述成立，請選取 [是]。否則，請選取 [否]。 注意；每答對一個選項，可得一分。",
    options: null,
    subQuestions: [{"text": "在自定義視覺", "answer": "否"}, {"text": "您可以在自訂視覺", "answer": "是"}, {"text": "在自訂視覺", "answer": "是"}],
  ...
  },
  {
    ...
    options: ["A. 使用知識庫以互動方式回答使用者問題的網站", "B. 可以回答諸如「今天天氣如何？」等問題的家用智慧型裝置", "C. 監控機器溫度，以在溫度達到特定閾值時打開風扇", "D. 自動將車前燈插入汽車的生產線機械"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 類別", "B. 文字", "C. 數值 (Numeric)", "D. 布林值"],
    subQuestions: null,
    answer: "C. 數值 (Numeric)",
  ...
  },
  {
    ...
    options: ["A. 就訓練使用標籤，評估則使用特徵。", "B. 將資料隨機分割為訓練用資料列和評估用資料列。", "C. 將資料隨機分割為訓練用資料行和評估用資料行。", "D. 就訓練使用特徵，評估則使用標籤。"],
    subQuestions: null,
  ...
  },
  {
    ...
    type: "single",
    question: "以下何者是 Microsoft 負責任 AI 準則的範例？",
    options: ["A. AI 系統應該使用黑箱模型。", "B. AI 系統應該公平待人。", "C. AI 系統不應該透露其設計細節。", "D. AI 系統應該保即開發人員的利益。"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. Azure Kubernetes Service (AKS)", "B. 機器學習", "C. 深度學習", "D. 電腦視覺"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 包容性", "B. 透明度 (Transparency)", "C. 可靠性和安全性 (Reliability and Safety)", "D. 公平性"],
    subQuestions: null,
    answer: "C. 可靠性和安全性 (Reliability and Safety)",
  ...
  },
  {
    ...
    options: ["A. QnA Maker (現為自訂問題解答)", "B. Azure 機器人服務 (Azure Bot Service)", "C. 文字分析", "D. Language Understanding (LUIS)"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 修改有利於錯誤否定的閾值。", "B. 修改有利於誤判為真的閾值。 (應理解為調整閾值以減少FP)", "C. 在定型資料中納入測試資料。", "D. 增加定型反覆運算的數目。"],
    subQuestions: null,
    answer: "B. 修改有利於誤判為真的閾值。 (更精確的說法是：提高分類閾值)",
  ...
  },
  {
    ...
    options: ["A. 迴歸", "B. 叢集", "C. 1. - 隔離北極熊和棕熊的影像 (A. 影像分類) 2. - 判斷相片中熊的位置 (B. 物件偵測) 3. - 判斷影像中哪些圖元是熊的一部分。 (C. 影像分割)", "D. 強化學習"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 翻譯", "B. 語音合成 (Speech Synthesis / TTS)", "C. 語音辨識", "D. 語言模組化"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 物件偵測 (Object Detection)", "B. 光學字元辨識 (OCR)", "C. 場景分割"],
    subQuestions: null,
    answer: "A. 物件偵測 (Object Detection)",
  ...
  },
  {
    ...
    options: ["A. 翻譯工具 (Translator)", "B. 文字分析", "C. 語音", "D. Language Understanding (LUIS)"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. [ ] Scala", "B. [ ] C#", "C. [x] Python", "D. [x] R"],
    subQuestions: null,
  ...
  },
  {
    ...
    question: "在下列每一項敘述中，如果敘述成立，請選取 [是]。否則，請選取 [否]。 注意：每答對一個選項，可得一分。",
    options: null,
    subQuestions: [{"text": "聊天機器人", "answer": "否"}, {"text": "Azure Bot Service", "answer": "是"}, {"text": "使用 Azure Bot Service", "answer": "是"}],
  ...
  },
  {
    ...
    options: ["A. 權責性", "B. 可靠性和安全性", "C. 公平性 (Fairness)", "D. 透明度"],
    subQuestions: null,
    answer: "C. 公平性 (Fairness)",
  ...
  },
  {
    ...
    options: ["A. 機器學習", "B. 深度學習", "C. 答案 (正確順序)： 資料準備 模型訓練 模型評估", "D. 電腦視覺"],
    subQuestions: null,
    answer: "C. 答案 (正確順序)： 資料準備 模型訓練 模型評估",
  ...
  },
  {
    ...
    options: ["A. [ ] 該聊天機器人將一律提供準確的資料。", "B. [x] 基礎知識資料可用來限制聊天機器人的輸出。", "C. [ ] 該聊天機器人適合用來執行醫療診斷。", "D. [x] 該聊天機器人可能會使用不準確的資料回應。"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. GPT-3.5", "B. GPT-4", "C. Codex", "D. DALL-E"],
    subQuestions: null,
    answer: "D. DALL-E",
  ...
  },
  {
    ...
    options: ["A. Azure AI 自訂視覺分類", "B. Azure AI 電腦視覺讀取", "C. Azure AI 自訂視覺物件偵測", "D. Azure AI 電腦視覺光學字元辨識(OCR)"],
    subQuestions: null,
    answer: "C. Azure AI 自訂視覺物件偵測",
  ...
  },
  {
    ...
    options: ["A. 機器學習", "B. 深度學習", "C. 類別 (Categorical)", "D. 電腦視覺"],
    subQuestions: null,
  ...
  },
  {
    ...
    question: "在下列每一項敘述中，如果敘述成立，請選取 [是]。否則，請選取 [否]。 注意：每答對一個選項，可得一分。",
    options: null,
    subQuestions: [{"text": "Azure Bot Service", "answer": "是"}, {"text": "Azure Bot Service", "answer": "是"}, {"text": "Azure Bot Service", "answer": "否"}],
  ...
  },
  {
    ...
    options: ["A. 偵測影像中的色彩配置。", "B. 擷取關鍵詞組。", "C. 預測股票價格。", "D. 將文字翻譯為不同語言。", "E. 偵測影像中的商標。"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. Azure 認知搜尋", "B. 翻譯工具", "C. 語音", "D. 語言 (Language)"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 使用圖形使用者介面(GUI)從 Azure 機器學習設計器定義並運行機器學習實驗", "B. 創建用作工作站的計算實例", "C. 使用圖形用戶介面(GUI)運行自動機器學習實驗", "D. 基於逗號分隔值(CSV)文件創建數據集"],
    subQuestions: null,
  ...
  },
  {
    ...
    question: "在下列每一項敘述中，如果敘述成立，請選取 [是]。否則，請選取 [否]。 注意：每答對一個選項，可得一分。",
    options: null,
    subQuestions: [{"text": "語言服務", "answer": "是"}, {"text": "語言服務", "answer": "否"}, {"text": "語言服務", "answer": "是"}],
  ...
  },
  {
    ...
    options: ["A. 回歸", "B. 分類", "C. 叢集 (Clustering)"],
    subQuestions: null,
    answer: "C. 叢集 (Clustering)",
  ...
  },
  {
    ...
    options: ["A. 語言偵測", "B. 關鍵片語摘取", "C. 情感分析 (Sentiment Analysis)", "D. 實體辨識"],
    subQuestions: null,
    answer: "C. 情感分析 (Sentiment Analysis)",
  ...
  },
  {
    ...
    options: ["A. 機器學習", "B. 深度學習", "C. 電腦視覺", "D. 選取資料集中的資料行 (Select Columns in Dataset) (並結合其視覺化功能)"],
    subQuestions: null,
  ...
  },
  {
    ...
    question: "在下列每一項敘述中，如果敘述成立，請選取 [是]。否則，請選取 [否]。 注意：每答對一個選項，可得一分。",
    options: null,
    subQuestions: [{"text": "您可以使用語音服務", "answer": "是"}, {"text": "您可以使用文字分析", "answer": "是"}, {"text": "您可以使用語音服務", "answer": "是"}],
  ...
  },
  {
    ...
    options: ["A. 語言模組化", "B. 翻譯 (Translation)", "C. 關鍵片語摘取", "D. 語音辨識"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. Azure AI 語言 (Language)", "B. Azure AI 翻譯工具", "C. Azure AI 語音", "D. Azure AI 文件智慧"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 回歸 (Regression)", "B. 聚類 (Clustering)", "C. 分類"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 光學字元辨識 (OCR)", "B. 物件偵測", "C. 影像分類", "D. 腦部偵測 (應為臉部偵測)"],
    subQuestions: null,
    answer: "A. 光學字元辨識 (OCR)",
  ...
  },
  {
    ...
    options: ["A. 機器學習", "B. 電腦視覺", "C. 異常偵測 (Anomaly Detection)", "D. 自然語言處理 (NLP)"],
    subQuestions: null,
  ...
  },
  {
    ...
    options: ["A. 翻譯工具服務", "B. Azure Machine Learning 模型", "C. 表格辨識器模型", "D. Azure Bot Service"],
    subQuestions: null,
    answer: "D. Azure Bot Service",
  ...
  },
  {
    ...
    options: ["A. 迴歸", "B. 叢集", "C. 1. - 產生影像標題。 (A. 影像分類 - 雖然影像描述更準確，但分類是最接近的選項，或理解為生成描述性標籤) 2. - 擷取電影海報影像中的電影名稱。 (B. 光學字元辨識) 3. - 找到影像中的車輛。 (C. 物件偵測)", "D. 強化學習"],
    subQuestions: null,
